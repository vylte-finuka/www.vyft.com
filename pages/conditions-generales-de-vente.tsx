                ...
                <div className={styles.container2}>
                    ...
                    <main className={styles.main}>
                        ...
                        <ul className={styles.bodyonwhite} style={{ marginBottom: 24 }}>
                            ...
                            <li>
                                <b>Prestataire sécurisé</b> : service tiers spécialisé et certifié pour la gestion des comptes, abonnements et paiements (ex : Stripe).
                            </li>
                            <li>
                        ...
                        <ul className={styles.bodyonwhite} style={{ marginBottom: 24 }}>
                            ...
                            <li>Gestion des abonnements via un <b>prestataire sécurisé</b> (Stripe) en mode &quot;pay as you go&quot;.</li>
                        ...
                        <h3 className={styles.bodyonwhite}>
                            L’abonnement fonctionne aujourd’hui en mode &quot;pay as you go&quot; via un <b>prestataire sécurisé</b> (Stripe). Nous manipulons les données uniquement dans les cas nécessaires. L’abonnement peut être révoqué à tout moment en contactant le support à l’adresse support@vylte-finuka.com.
                        </h3>
