...
"[project]/node_modules/@walletconnect/utils/dist/index.js [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "MemoryStore": (()=>mu),
    "ONE_THOUSAND": (()=>ui),
    "REACT_NATIVE_PRODUCT": (()=>pr),
    "RELAYER_DEFAULT_PROTOCOL": (()=>as),
    "SDK_ERRORS": (()=>ar),
    "SDK_TYPE": (()=>br),
    "SLASH": (()=>gr),
    "TYPE_0": (()=>Mn),
    ...
    "TYPE_2": (()=>ve),
    "UTF8": (()=>se),
    "addResourceToRecap": (()=>ho),
    "addSignatureToExtrinsic": (()=>Ps),
    "appendToQueryString": (()=>yr),
    "assertType": (()=>mi),
    "assignAbilityToActions": (()=>yn),
    "base64Decode": (()=>uo),
    "base64Encode": (()=>ao),
    "buildApprovedNamespaces": (()=>Ga),
    "buildAuthObject": (()=>Mc),
    "buildNamespacesFromAuth": (()=>za),
    "buildRecapStatement": (()=>go),
    "buildSignedExtrinsicHash": (()=>Bu),
    "calcExpiry": (()=>_i),
    "capitalize": (()=>Ii),
    "capitalizeWord": (()=>Ir),
    "createDelayedPromise": (()=>Ai),
    "createEncodedRecap": (()=>Zc),
    "createExpiringPromise": (()=>Si),
    "createLogger": (()=>Iu),
    "createRecap": (()=>lo),
    "decodeRecap": (()=>kt),
    "decodeTypeByte": (()=>Gt),
    "decodeTypeTwoEnvelope": (()=>xa),
    "decrypt": (()=>wa),
    "deriveExtrinsicHash": (()=>Hs),
    "deriveSymKey": (()=>ga),
    "deserialize": (()=>ze),
    "encodeRecap": (()=>Ce),
    "encodeTypeByte": (()=>qn),
    "encodeTypeTwoEnvelope": (()=>va),
    "encrypt": (()=>ma),
    "engineEvent": (()=>$i),
    "enumify": (()=>Bi),
    "extractSolanaTransactionId": (()=>Nc),
    "formatAccountId": (()=>sr),
    "formatAccountWithChain": (()=>Js),
    "formatChainId": (()=>or),
    "formatDeeplinkUrl": (()=>Ar),
    "formatExpirerTarget": (()=>on),
    "formatIdTarget": (()=>Ni),
    "formatMessage": (()=>so),
    "formatMessageContext": (()=>wi),
    "formatRelayParams": (()=>ps),
    "formatRelayRpcUrl": (()=>bi),
    "formatStatementFromRecap": (()=>wn),
    "formatTopicTarget": (()=>Oi),
    "formatUA": (()=>xr),
    "formatUri": (()=>ja),
    "fromBase64": (()=>cn),
    "generateKeyPair": (()=>ha),
    "generateRandomBytes32": (()=>pa),
    "getAccountsChains": (()=>zt),
    "getAccountsFromNamespaces": (()=>ti),
    "getAddressFromAccount": (()=>ir),
    "getAddressesFromAccounts": (()=>Qs),
    "getAlgorandTransactionId": (()=>Rc),
    "getAppId": (()=>hi),
    "getAppMetadata": (()=>mr),
    "getBrowserOnlineStatus": (()=>$s),
    "getChainFromAccount": (()=>cr),
    "getChainsFromAccounts": (()=>fr),
    "getChainsFromNamespace": (()=>Se),
    "getChainsFromNamespaces": (()=>ei),
    "getChainsFromRecap": (()=>Yc),
    "getChainsFromRequiredNamespaces": (()=>ni),
    "getCommonValuesInArrays": (()=>sn),
    "getCryptoKeyFromKeyData": (()=>fs),
    "getDecodedRecapFromResources": (()=>io),
    "getDeepLink": (()=>Ci),
    "getDidAddress": (()=>bn),
    "getDidAddressNamespace": (()=>ro),
    "getDidAddressSegments": (()=>ye),
    "getDidChainId": (()=>no),
    "getEnvironment": (()=>Mt),
    "getHttpUrl": (()=>yi),
    "getInternalError": (()=>bt),
    ...
    "getLastItems": (()=>Br),
    "getLinkModeURL": (()=>La),
    "getMethodsFromRecap": (()=>zc),
    "getNamespacedDidChainId": (()=>oo),
    "getNamespacesChains": (()=>ys),
    "getNamespacesEvents": (()=>Fa),
    "getNamespacesEventsForChainId": (()=>ws),
    "getNamespacesFromAccounts": (()=>xs),
    "getNamespacesMethods": (()=>qa),
    "getNamespacesMethodsForChainId": (()=>ms),
    "getNearTransactionIdFromSignedTransaction": (()=>_c),
    "getNearUint8ArrayFromBytes": (()=>Wr),
    "getNodeOnlineStatus": (()=>Cs),
    "getReCapActions": (()=>fo),
    "getReactNativeOnlineStatus": (()=>Ts),
    "getRecapAbilitiesFromResource": (()=>Fc),
    "getRecapFromResources": (()=>je),
    "getRecapResource": (()=>co),
    "getRelayClientMetadata": (()=>gi),
    "getRelayProtocolApi": (()=>Oa),
    "getRelayProtocolName": (()=>Sa),
    "getRequiredNamespacesFromNamespaces": (()=>Za),
    "getSdkError": (()=>Vt),
    "getSearchParamFromURL": (()=>ji),
    "getSignDirectHash": (()=>$c),
    "getSuiDigest": (()=>Uc),
    "getUniqueValues": (()=>tn),
    "getWalletSendCallsHashes": (()=>Tc),
    "handleDeeplinkRedirect": (()=>Ti),
    "hasOverlap": (()=>At),
    "hashEthereumMessage": (()=>hn),
    "hashKey": (()=>ba),
    "hashMessage": (()=>ya),
    "isAndroid": (()=>li),
    "isAppVisible": (()=>yu),
    ...
    "isTelegram": (()=>Or),
    "isTestRun": (()=>ki),
    "isTypeOneEnvelope": (()=>Ba),
    "isTypeTwoEnvelope": (()=>Ia),
    "isUndefined": (()=>Dt),
    "isValidAccountId": (()=>Es),
    "isValidAccounts": (()=>As),
    "isValidActions": (()=>Os),
    ...
    "isValidChainId": (()=>Ie),
    "isValidChains": (()=>Bs),
    "isValidController": (()=>tu),
    "isValidEip1271Signature": (()=>Xr),
    "isValidEip191Signature": (()=>Yr),
    "isValidErrorReason": (()=>su),
    "isValidEvent": (()=>fu),
    "isValidId": (()=>ru),
    "isValidNamespaceAccounts": (()=>Ss),
    "isValidNamespaceActions": (()=>Yn),
    "isValidNamespaceChains": (()=>Is),
    "isValidNamespaceMethodsOrEvents": (()=>zn),
    "isValidNamespaces": (()=>Ns),
    "isValidNamespacesChainId": (()=>au),
    "isValidNamespacesEvent": (()=>lu),
    "isValidNamespacesRequest": (()=>uu),
    "isValidNumber": (()=>Xe),
    "isValidObject": (()=>Ye),
    "isValidParams": (()=>ou),
    "isValidRecap": (()=>mt),
    ...
    "isValidRelays": (()=>nu),
    "isValidRequest": (()=>iu),
    "isValidRequestExpiry": (()=>pu),
    "isValidRequiredNamespaces": (()=>eu),
    "isValidResponse": (()=>cu),
    "isValidString": (()=>ft),
    "isValidUrl": (()=>Wa),
    "mapEntries": (()=>Ei),
    "mapToObj": (()=>vi),
    "mergeArrays": (()=>ut),
    "mergeEncodedRecaps": (()=>Gc),
    "mergeRecaps": (()=>po),
    "mergeRequiredAndOptionalNamespaces": (()=>Ya),
    "normalizeNamespaces": (()=>Ee),
    "objToMap": (()=>xi),
    "openDeeplink": (()=>Sr),
    "parseAccountId": (()=>Qe),
    "parseChainId": (()=>Je),
    "parseContextNames": (()=>Er),
    "parseExpirerTarget": (()=>Ui),
    "parseNamespaceKey": (()=>vs),
    "parseRelayParams": (()=>ds),
    "parseTopic": (()=>hs),
    "parseUri": (()=>Ca),
    "populateAppMetadata": (()=>pi),
    "populateAuthPayload": (()=>Kc),
    "recapHasResource": (()=>qc),
    "serialize": (()=>Fn),
    "sleep": (()=>Pi),
    "ss58AddressToPublicKey": (()=>ks),
    "subscribeToBrowserNetworkChange": (()=>js),
    "subscribeToNetworkChange": (()=>bu),
    "subscribeToReactNativeNetworkChange": (()=>Ls),
    "toBase64": (()=>Ur),
    "uuidv4": (()=>Li),
    "validateDecoding": (()=>Ea),
    "validateEncoding": (()=>cs),
    "validateSignedCacao": (()=>Vc),
    "verifyP256Jwt": (()=>Aa),
    "verifySignature": (()=>zr)
});
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$detect$2d$browser$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/detect-browser/es/index.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$metadata$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/window-metadata/dist/cjs/index.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Signature$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Signature$3e$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/utils/node_modules/ox/_esm/core/Signature.js [client] (ecmascript) <export * as Signature>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Secp256k1$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Secp256k1$3e$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/utils/node_modules/ox/_esm/core/Secp256k1.js [client] (ecmascript) <export * as Secp256k1>");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$msgpack$2f$msgpack$2f$dist$2e$esm$2f$decode$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@msgpack/msgpack/dist.esm/decode.mjs [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$msgpack$2f$msgpack$2f$dist$2e$esm$2f$encode$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@msgpack/msgpack/dist.esm/encode.mjs [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@scure/base/lib/esm/index.js [client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/uint8arrays/esm/src/from-string.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$concat$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/uint8arrays/esm/src/concat.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$relay$2d$api$2f$dist$2f$index$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@walletconnect/relay-api/dist/index.es.js [client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$blakejs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/blakejs/index.js [client] (ecmascript)");
...
function rn() {
    return typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"] < "u" && typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].versions < "u" && typeof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$client$5d$__$28$ecmascript$29$__["default"].versions.node < "u";
}
function It() {
    return !(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDocument"])() && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getNavigator"])() && navigator.product === pr;
}
function li() {
...
function Xt() {
    return !rn() && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getNavigator"])() && !!(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDocument"])();
}
function Mt() {
...
function mr() {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$metadata$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getWindowMetadata"])() || {
        name: "",
        description: "",
        url: "",
        icons: [
...
function gi(t, e) {
    ...
    return r === "browser" && (o.host = ((n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getLocation"])()) == null ? void 0 : n.host) || "unknown"), o;
}
function wr() {
    if (Mt() === et.reactNative && typeof global < "u" && typeof (global == null ? void 0 : global.Platform) < "u") {
    ...
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$detect$2d$browser$2f$es$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["detect"])();
...
function vr() {
    ...
    return e === et.browser ? [
        e,
        ((t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getLocation"])()) == null ? void 0 : t.host) || "unknown"
    ].join(":") : e;
}
function xr(t, e, n) {
    const r = wr(), o = vr();
...
function Ai(t = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$time$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FIVE_MINUTES"], e) {
    const n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$time$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toMiliseconds"])(t || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$time$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["FIVE_MINUTES"]);
    let r, o, s, i;
    return {
        resolve: (c)=>{
...
async function Ti({ id: t, topic: e, wcDeepLink: n }) {
    ...
    try {
        ...
        if (c === et.browser) {
            if (!((r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$window$2d$getters$2f$dist$2f$cjs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["getDocument"])()) != null && r.hasFocus())) {
                console.warn("Document does not have focus, skipping deeplink.");
                return;
            }
            Sr(i);
        } else c === et.reactNative && typeof (global == null ? void 0 : global.Linking) < "u" && await global.Linking.openURL(i);
    } catch (o) {
        console.error(o);
    }
}
...
function Ur(t, e = !1) {
    const n = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t).toString("base64");
    return e ? n.replace(/[=]/g, "") : n;
}
function cn(t) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t, "base64").toString("utf-8");
}
function Pi(t) {
...
${t.length}`, n = new TextEncoder().encode(e + t);
    return "0x" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(fc(n)).toString("hex");
}
...
function Yr(t, e, n) {
    const r = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Signature$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Signature$3e$__["Signature"].fromHex(n);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$utils$2f$node_modules$2f$ox$2f$_esm$2f$core$2f$Secp256k1$2e$js__$5b$client$5d$__$28$ecmascript$29$__$3c$export__$2a$__as__Secp256k1$3e$__["Secp256k1"].recoverAddress({
        payload: hn(e),
        signature: r
...
function Nc(t) {
    ...
    const s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t, "base64").slice(1, 65);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base58"].encode(s);
}
function Uc(t) {
    const e = new Uint8Array(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t, "base64")), n = Array.from("TransactionData::").map((s)=>s.charCodeAt(0)), r = new Uint8Array(n.length + e.length);
    r.set(n), r.set(e, n.length);
    const o = Ac(r, {
        dkLen: 32
    });
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base58"].encode(o);
}
function _c(t) {
    const e = new Uint8Array(Te(Wr(t)));
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base58"].encode(e);
}
function Wr(t) {
...
function Rc(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t, "base64"), n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$msgpack$2f$msgpack$2f$dist$2e$esm$2f$decode$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["decode"])(e).txn;
    if (!n) throw new Error("Invalid signed transaction: missing 'txn' field");
    const r = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$msgpack$2f$msgpack$2f$dist$2e$esm$2f$encode$2e$mjs__$5b$client$5d$__$28$ecmascript$29$__["encode"])(n), o = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from("TX"), s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].concat([
        o,
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(r)
    ]), i = vc(s);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base32"].encode(i).replace(/=+$/, "");
}
function pn(t) {
    const e = [];
    let n = BigInt(t);
    for(; n >= BigInt(128);)e.push(Number(n & BigInt(127) | BigInt(128))), n >>= BigInt(7);
    return e.push(Number(n)), __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(e);
}
function $c(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.signed.bodyBytes, "base64"), n = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.signed.authInfoBytes, "base64"), r = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.signature.signature, "base64"), o = [];
    o.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from([
        10
    ])), o.push(pn(e.length)), o.push(e), o.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from([
        18
    ])), o.push(pn(n.length)), o.push(n), o.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from([
        26
    ])), o.push(pn(r.length)), o.push(r);
    const s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].concat(o), i = Te(s);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(i).toString("hex").toUpperCase();
}
function Tc(t) {
    var e, n;
    const r = [];
...
function ao(t) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(JSON.stringify(t)).toString("base64");
}
function uo(t) {
    return JSON.parse(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t, "base64").toString("utf-8"));
}
function mt(t) {
...
function ha() {
    ...
    return {
        privateKey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(t, rt),
        publicKey: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(e, rt)
    };
}
function pa() {
    const t = Kt(Kn);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(t, rt);
}
function ga(t, e) {
    const n = kn.getSharedSecret((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t, rt), (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(e, rt)), r = Bf(Pe, n, void 0, void 0, Kn);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(r, rt);
}
function ba(t) {
    const e = Pe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t, rt));
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(e, rt);
}
function ya(t) {
    const e = Pe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t, se));
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(e, rt);
}
function qn(t) {
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(`${t}`, Vn);
}
function Gt(t) {
    return Number((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(t, Vn));
}
function ss(t) {
...
function ma(t) {
    ...
    const n = typeof t.senderPublicKey < "u" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t.senderPublicKey, rt) : void 0, r = typeof t.iv < "u" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t.iv, rt) : Kt(xe), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t.symKey, rt), s = Ao(o, r).encrypt((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t.message, se)), i = Fn({
        type: e,
        sealed: s,
        iv: r,
        senderPublicKey: n
...
function wa(t) {
    const e = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t.symKey, rt), { sealed: n, iv: r } = ze({
        encoded: t.encoded,
        encoding: t.encoding
    }), o = Ao(e, r).decrypt(n);
    if (o === null) throw new Error("Failed to decrypt");
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(o, se);
}
function va(t, e) {
    const n = qn(ve), r = Kt(xe), o = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(t, se), s = Fn({
        type: n,
        sealed: o,
        iv: r
    });
...
function xa(t, e) {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(n, se);
}
function Fn(t) {
    if (Gt(t.type) === ve) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$concat$2e$js__$5b$client$5d$__$28$ecmascript$29$__["concat"])([
        t.type,
        t.sealed
    ]), oe);
    if (Gt(t.type) === ie) {
...
function ze(t) {
    const e = (t.encoding || oe) === Ge ? is(t.encoded) : t.encoded, n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$from$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["fromString"])(e, oe), r = n.slice(da, os), o = os;
    if (Gt(r) === ie) {
...
function Ea(t, e) {
    ...
    return cs({
        type: Gt(n.type),
        senderPublicKey: typeof n.senderPublicKey < "u" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$to$2d$string$2e$js__$5b$client$5d$__$28$ecmascript$29$__["toString"])(n.senderPublicKey, rt) : void 0,
...
function fs(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.x, "base64"), n = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.y, "base64");
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$concat$2e$js__$5b$client$5d$__$28$ecmascript$29$__["concat"])([
        new Uint8Array([
            4
        ]),
        e,
...
function Aa(t, e) {
    const [n, r, o] = t.split("."), s = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(is(o), "base64");
    if (s.length !== 64) throw new Error("Invalid signature length");
    const i = s.slice(0, 32), c = s.slice(32, 64), f = `${n}.${r}`, u = Pe(f), a = fs(e);
    if (!la.verify((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$uint8arrays$2f$esm$2f$src$2f$concat$2e$js__$5b$client$5d$__$28$ecmascript$29$__["concat"])([
        i,
        c
    ]), u, a)) throw new Error("Invalid signature");
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$relay$2d$auth$2f$dist$2f$index$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["decodeJWT"])(t).payload;
}
const as = "irn";
function Sa(t) {
    return t?.relay || {
...
function Oa(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$relay$2d$api$2f$dist$2f$index$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["RELAY_JSONRPC"][t];
...
function ks(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base58"].decode(t);
...
function Hs(t) {
    const e = Wn(t), n = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$blakejs$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["blake2b"])(e, void 0, 32);
    return "0x" + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(n).toString("hex");
}
function Wn(t) {
...
function vu(t) {
    const e = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$scure$2f$base$2f$lib$2f$esm$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["base58"].decode(t)[0];
...
function Bu(t) {
    const e = Uint8Array.from(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(t.signature, "hex")), n = ks(t.transaction.address), r = Ps({
        publicKey: n,
        signature: e,
        payload: t.transaction
    }), o = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$buffer$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["Buffer"].from(r).toString("hex");
    return Hs(o);
}
function Iu({ logger: t, name: e }) {
    const n = typeof t == "string" ? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$walletconnect$2f$logger$2f$dist$2f$index$2e$es$2e$js__$5b$client$5d$__$28$ecmascript$29$__["generatePlatformLogger"])({
        opts: {
            level: t,
            name: e
        }
...
//# sourceMappingURL=node_modules_%40walletconnect_utils_dist_index_c9140244.js.map