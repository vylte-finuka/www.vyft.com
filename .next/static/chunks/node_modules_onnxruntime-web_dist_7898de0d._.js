...
{
__turbopack_context__.v("/_next/static/media/ort-wasm-simd-threaded.jsep.2a3eaaa4.wasm");}}),
"[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs (static in ecmascript)": ((__turbopack_context__) => {

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.v("/_next/static/media/ort.bundle.min.6eabb04f.mjs");}}),
"[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var Np = Object.getOwnPropertyNames;
var Vp = Object.prototype.hasOwnProperty;
var On = ((e1)=>("TURBOPACK compile-time value", "function") < "u" ? ("TURBOPACK member replacement", __turbopack_context__.z) : typeof Proxy < "u" ? new Proxy(e1, {
...
var Dt = (e1, t)=>{
    for(var r in t)zn(e1, r, {
        get: t[r],
        enumerable: !0
    });
}, Wp = (e1, t, r, n)=>{
    if (t && typeof t == "object" || typeof t == "function") for (let o of Np(t))!Vp.call(e1, o) && o !== r && zn(e1, o, {
        get: ()=>t[o],
        enumerable: !(n = Up(t, o)) || n.enumerable
    });
    return e1;
};
var Ft = (e1)=>Wp(zn({}, "__esModule", {
        value: !0
    }), e1);
var fr, vt, $t, Lp, Fi, Bn = U(()=>{
    "use strict";
    fr = new Map, vt = [], $t = (e1, t, r)=>{
        if (t && typeof t.init == "function" && typeof t.createInferenceSessionHandler == "function") {
            let n = fr.get(e1);
            if (n === void 0) fr.set(e1, {
                backend: t,
                priority: r
            });
            else {
        ...
        let t = e1.executionProviders || [], r = t.map((d)=>typeof d == "string" ? d : d.name), n = r.length === 0 ? vt : r, o, i = [], a = new Set;
        for (let d of n){
            let c = await Lp(d);
...
var Zi, Me, Dn = U(()=>{
    ...
    Object.defineProperty(Me, "logLevel", {
        enumerable: !0
    });
});
var ge, Qi = U(()=>{
    ...
    Yi = (e1, t)=>{
        ...
        if (n != null) {
            ...
            for(let _ = 0; _ < i; _++)for(let S = 0; S < o; S++){
                let $ = (e1.data[m++] - c[0]) * d[0], v = (e1.data[f++] - c[1]) * d[1], x = (e1.data[b++] - c[2]) * d[2], T = g === -1 ? 255 : (e1.data[g++] - c[3]) * d[3];
        ...
        if (r != null) {
            ...
            for(let E = 0; E < i * o; b += f, g += f, _ += f, S += f, E++)n.data[b] = (e1.data[$++] - p[0]) * c[0], n.data[g] = (e1.data[v++] - p[1]) * c[1], n.data[_] = (e1.data[x++] - p[2]) * c[2], n.data[S] = T === -1 ? 255 : (e1.data[T++] - p[3]) * c[3];
        } else throw new Error("Can not access image data");
        return n;
    };
});
var Mn, ea, ta, ra, na, oa, ia = U(()=>{
    "use strict";
    hr();
    Mn = (e1, t)=>{
        ...
        for(let E = 0; E < c; E++, f += m, g += m, b += m, _ += m)p[S++] = (e1[f] + a[0]) / i[0], p[$++] = (e1[b] + a[1]) / i[1], p[v++] = (e1[g] + a[2]) / i[2], x !== -1 && _ !== -1 && (p[x++] = (e1[_] + a[3]) / i[3]);
        return d === "RGBA" ? new Pe("float32", p, [
            1,
            4,
            r,
            n
        ...
        let r = typeof HTMLImageElement < "u" && e1 instanceof HTMLImageElement, n = typeof ImageData < "u" && e1 instanceof ImageData, o = typeof ImageBitmap < "u" && e1 instanceof ImageBitmap, i = typeof e1 == "string", a, u = t ?? {}, d = ()=>{
        ...
        if (r) {
            let p = d();
            p.width = e1.width, p.height = e1.height;
            let m = c(p);
            if (m != null) {
                let f = e1.height, b = e1.width;
                ...
                m.drawImage(e1, 0, 0), a = m.getImageData(0, 0, b, f).data;
            } else throw new Error("Can not access image data");
        } else if (n) {
            let p, m;
            if (t !== void 0 && t.resizedWidth !== void 0 && t.resizedHeight !== void 0 ? (p = t.resizedHeight, m = t.resizedWidth) : (p = e1.height, m = e1.width), t !== void 0 && (u = t), u.format = "RGBA", u.height = p, u.width = m, t !== void 0) {
                let f = d();
                f.width = m, f.height = p;
                let b = c(f);
                if (b != null) b.putImageData(e1, 0, 0), a = b.getImageData(0, 0, m, p).data;
                else throw new Error("Can not access image data");
            } else a = e1.data;
        } else if (o) {
            ...
            if (m != null) {
                let f = e1.height, b = e1.width;
                return m.drawImage(e1, 0, 0, b, f), a = m.getImageData(0, 0, b, f).data, u.height = f, u.width = b, Mn(a, u);
            } else throw new Error("Can not access image data");
        } else {
...
var xt, qt, aa, sa, ua = U(()=>{
    ...
    xt = new Map([
        ...
        if (!aa) {
            aa = !0;
            let e1 = typeof BigInt64Array < "u" && BigInt64Array.from, t = typeof BigUint64Array < "u" && BigUint64Array.from, r = globalThis.Float16Array, n = typeof r < "u" && r.from;
            e1 && (xt.set("int64", BigInt64Array), qt.set(BigInt64Array, "int64")), t && (xt.set("uint64", BigUint64Array), qt.set(BigUint64Array, "uint64")), n ? (xt.set("float16", r), qt.set(r, "float16")) : xt.set("float16", Uint16Array);
        }
    };
});
var da, la, ca = U(()=>{
    ...
    da = (e1)=>{
        ...
        switch(e1.location){
            case "cpu":
                return new Pe(e1.type, e1.data, t);
            case "cpu-pinned":
                return new Pe({
                    location: "cpu-pinned",
                    data: e1.data,
...
var gr, pa, Re, Oe, Un = U(()=>{
    "use strict";
    Dn();
    gr = (e1, t)=>{
        (typeof Me.trace > "u" ? !Me.wasm.trace : !Me.trace) || console.timeStamp(`${e1}::ORT::${t}`);
    }, pa = (e1, t)=>{
        ...
        (typeof Me.trace > "u" ? !Me.wasm.trace : !Me.trace) || pa("BEGIN", e1);
    }, Oe = (e1)=>{
        (typeof Me.trace > "u" ? !Me.wasm.trace : !Me.trace) || pa("END", e1);
    };
});
var br, ma = U(()=>{
    "use strict";
            ...
            if (typeof r == "object") {
                ...
                if (Array.isArray(r)) {
                    ...
                    for (let m of this.outputNames)if (p.indexOf(m) !== -1) {
                        let f = r[m];
                        (f === null || f instanceof Ge) && (c = !0, a = !1, o[m] = f);
                    }
                    if (c) {
                        if (typeof n == "object" && n !== null) i = n;
                        else if (typeof n < "u") throw new TypeError("'options' must be an object.");
...
var wa, va, Hp, xa = U(()=>{
    ...
    Hp = va ? null : (e1)=>new Worker(e1 ?? Ue, {
            type: "module",
            name: wa
        });
});
...
var Wn, Sa, Fp, qp, Ia = U(()=>{
    "use strict";
    Sa = (Wn = __TURBOPACK__import$2e$meta__.url, async function(e1 = {}) {
        var t, r, n = e1, o = new Promise((s, l)=>{
            t = s, r = l;
        }), i = typeof window == "object", a = typeof WorkerGlobalScope < "u", u = a && self.name?.startsWith("em-pthread");
        n.mountExternalData = (s, l)=>{
            s.startsWith("./") && (s = s.substring(2)), (n.Eb || (n.Eb = new Map)).set(s, l);
...
`));
        ...
        (i || a) && (a ? _ = self.location.href : typeof document < "u" && document.currentScript && (_ = document.currentScript.src), Wn && (_ = Wn), _ = _.startsWith("blob:") ? "" : _.slice(0, _.replace(/[?#].*/, "").lastIndexOf("/") + 1), a && (f = (s)=>{
            ...
            return l.open("GET", s, !1), l.responseType = "arraybuffer", l.send(null), new Uint8Array(l.response);
        }), m = async (s)=>{
            if (X(s)) return new Promise((h, y)=>{
                var w = new XMLHttpRequest;
                w.open("GET", s, !0), w.responseType = "arraybuffer", w.onload = ()=>{
        ...
        var T, E, I, z, O, D, L, q, Q, W, Z, we, H, j = n.wasmBinary, te = !1, X = (s)=>s.startsWith("file://");
        function ue() {
            ...
            let s = function(l) {
                try {
                    ...
                    if (y === "load") {
                        ...
                        _c(h.Ab), An(h.Ab, 0, 0, 1, 0, 0), No(), $n(h.Ab), $e || (Oi(), $e = !0);
                        try {
                            wc(h.fc, h.Hb);
                        } catch (w) {
                            if (w != "unwind") throw w;
        ...
        function dt(s) {
            throw x(s = "Aborted(" + s + ")"), te = !0, s = new WebAssembly.RuntimeError(s + ". Build with -sASSERTIONS for more info."), r(s), s;
        }
        function Oo() {
            return {
                a: {
        ...
        var cn = {
            ...
            830729: (s)=>n.Yb(s),
            830761: (s, l, h)=>{
                n.Kb(Number(s), Number(l), Number(h), !0);
            },
            830824: (s, l, h)=>{
            ...
            833228: (s, l, h, y, w)=>{
                n.jb("ReduceMean", s, {
                    keepDims: !!l,
                    noopWithEmptyAxes: !!h,
                    axes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(w) >>> 0)) : []
                });
            },
            833403: (s, l, h, y, w)=>{
                n.jb("ReduceMax", s, {
            ...
            835036: (s, l, h)=>{
                n.jb("Transpose", s, {
                    perm: l ? Array.from(C().subarray(Number(l) >>> 0, Number(h) >>> 0)) : []
                });
            },
            835160: (s, l, h, y)=>{
                n.jb("DepthToSpace", s, {
            ...
            835426: (s, l, h, y, w, A, B, R, G, K, ae, le, _e, ke, Bt)=>{
                n.jb("ConvTranspose", s, {
                    ...
                    wIsConst: ()=>!!ue()[K >>> 0],
                    outputPadding: ae ? Array.from(C().subarray(Number(ae) >>> 0, Number(le) >>> 0)) : [],
                    outputShape: _e ? Array.from(C().subarray(Number(_e) >>> 0, Number(ke) >>> 0)) : [],
                    activation: Te(Bt)
                });
            },
            835859: (s, l, h, y, w, A, B, R, G, K, ae, le, _e, ke)=>{
                n.jb("ConvTranspose", s, {
                    format: R ? "NHWC" : "NCHW",
                    autoPad: l,
                    dilations: Array.from(C().subarray(Number(h) >>> 0, 2 + (Number(h) >>> 0) >>> 0)),
                    group: y,
                    kernelShape: Array.from(C().subarray(Number(w) >>> 0, 2 + (Number(w) >>> 0) >>> 0)),
                    pads: Array.from(C().subarray(Number(A) >>> 0, 4 + (Number(A) >>> 0) >>> 0)),
                    strides: Array.from(C().subarray(Number(B) >>> 0, 2 + (Number(B) >>> 0) >>> 0)),
                    wIsConst: ()=>!!ue()[G >>> 0],
                    outputPadding: K ? Array.from(C().subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
                    outputShape: le ? Array.from(C().subarray(Number(le) >>> 0, Number(_e) >>> 0)) : [],
                    activation: Te(ke)
                });
            },
            ...
            837705: (s, l, h, y, w, A, B, R, G, K, ae, le, _e, ke)=>{
                n.jb("AveragePool", s, {
                    ...
                    count_include_pad: y,
                    storage_order: w,
                    dilations: A ? Array.from(C().subarray(Number(A) >>> 0, Number(B) >>> 0)) : [],
                    kernel_shape: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [],
                    pads: K ? Array.from(C().subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
                    strides: le ? Array.from(C().subarray(Number(le) >>> 0, Number(_e) >>> 0)) : []
                });
            },
            838184: (s, l)=>{
                n.jb("GlobalAveragePool", s, {
            ...
            840375: (s, l, h, y, w)=>{
                n.jb("Split", s, {
                    axis: l,
                    numOutputs: h,
                    splitSizes: y ? Array.from(C().subarray(Number(y) >>> 0, Number(w) >>> 0)) : []
                });
            },
            840531: (s)=>{
            ...
            840814: (s, l, h, y, w, A, B, R, G, K, ae)=>{
                n.jb("Resize", s, {
                    antialias: l,
                    axes: h ? Array.from(C().subarray(Number(h) >>> 0, Number(y) >>> 0)) : [],
                    coordinateTransformMode: Te(w),
                    cubicCoeffA: A,
                    excludeOutside: B,
                    extrapolationValue: R,
                    keepAspectRatioPolicy: Te(G),
                    mode: Te(K),
                    nearestMode: Te(ae)
                });
            },
            841176: (s, l, h, y, w, A, B)=>{
                n.jb("Slice", s, {
                    starts: l ? Array.from(C().subarray(Number(l) >>> 0, Number(h) >>> 0)) : [],
                    ends: y ? Array.from(C().subarray(Number(y) >>> 0, Number(w) >>> 0)) : [],
                    axes: A ? Array.from(C().subarray(Number(A) >>> 0, Number(B) >>> 0)) : []
                });
            },
            841440: (s)=>{
                n.jb("Tile", s, void 0);
            ...
            841854: (s, l, h, y, w)=>{
                n.jb("Pad", s, {
                    mode: l,
                    value: h,
                    pads: y ? Array.from(C().subarray(Number(y) >>> 0, Number(w) >>> 0)) : []
                });
            },
            841997: (s, l, h, y, w, A)=>{
                n.jb("BatchNormalization", s, {
                    epsilon: l,
                    momentum: h,
                    spatial: !!w,
                    trainingMode: !!y,
            ...
            842947: (s, l, h, y, w, A, B, R, G)=>{
                n.jb("Attention", s, {
                    ...
                    scale: w,
                    doRotary: A,
                    qkvHiddenSizes: B ? Array.from(C().subarray(Number(R) >>> 0, Number(R) + B >>> 0)) : [],
                    pastPresentShareBuffer: !!G
                });
            },
            843219: (s)=>{
            ...
            843391: (s, l, h, y, w, A, B, R, G, K, ae, le, _e, ke, Bt, Rp)=>{
                n.jb("Conv", s, {
                    format: le ? "NHWC" : "NCHW",
                    auto_pad: l,
                    dilations: h ? Array.from(C().subarray(Number(h) >>> 0, Number(y) >>> 0)) : [],
                    group: w,
                    kernel_shape: A ? Array.from(C().subarray(Number(A) >>> 0, Number(B) >>> 0)) : [],
                    pads: R ? Array.from(C().subarray(Number(R) >>> 0, Number(G) >>> 0)) : [],
                    strides: K ? Array.from(C().subarray(Number(K) >>> 0, Number(ae) >>> 0)) : [],
                    w_is_const: ()=>!!ue()[Number(_e) >>> 0],
                    activation: Te(ke),
                    activation_params: Bt ? Array.from(de().subarray(Number(Bt) >>> 0, Number(Rp) >>> 0)) : []
                });
            },
            843975: (s)=>{
                n.jb("Gelu", s, void 0);
        ...
        var Vo = (s)=>new Promise((l)=>{
                s.onmessage = (w)=>{
                    ...
                    } else A === "checkMailbox" ? nr() : A === "spawnThread" ? Do(w) : A === "cleanupThread" ? Uo(wt[w.hc]) : A === "loaded" ? (s.loaded = !0, l(s)) : A === "alert" ? alert(`Thread ${w.ic}: ${w.text}`) : w.target === "setimmediate" ? s.postMessage(w) : A === "callHandler" ? n[w.Qb](...w.args) : A && x(`worker sent an unknown command ${A}`);
                }, s.onerror = (w)=>{
        ...
        function Go(s, l, h, y) {
            ...
            var w = [];
            return u && w.length === 0 ? Lo(s, l >>>= 0, h, y) : (s = {
                ec: h,
                Ab: s,
                Hb: y,
                Mb: w
            }, u ? (s.Bb = "spawnThread", postMessage(s, w), 0) : Do(s));
        }
        ...
        function Tc(s, l, h) {
            h >>>= 0, it(s >>>= 0, {
                ...
                Cb: mt,
                readValueFromPointer: si(l, h, l.indexOf("u") == -1),
                Db: null
            });
        }
        var mt = 8;
        ...
        function Pc(s, l, h, y, w) {
            ...
            it(s, {
                ...
                toWireType: B,
                Cb: mt,
                readValueFromPointer: si(l, h, y !== 0),
                Db: null
            });
        }
        function zc(s, l, h) {
        ...
        function Gc(s, l) {
            (s >>>= 0) == l >>> 0 ? setTimeout(nr) : u ? postMessage({
                Gb: s,
                Bb: "checkMailbox"
            }) : (s = wt[s]) && s.postMessage({
                Bb: "checkMailbox"
            });
        }
        var xn = [];
            ...
            return function(l) {
                if (!te) {
                    if (ft === 0) {
                        ...
                        l((w = 0)=>{
                            if (!te && (li = w, h = !0, y)) {
                                ft = 2, ir(()=>Gi(Ze)), typeof MainLoop < "u" && MainLoop.Pb && MainLoop.resume(), w = !1;
                                try {
                                    var A = function() {
                                        var G = C()[Ze + 8 >>> 2 >>> 0];
                                ...
                                if (!Ze) {
                                    var R = Sn;
                                    R && (Sn = null, (w ? R.reject : R.resolve)(A), B = !0);
                                }
                                if (w && !B) throw A;
                            }
                        }), y = !0, h || (ft = 1, Ze = function() {
        ...
        var np = (s)=>{
            ...
            return h;
        }, hi = (s, l)=>Object.defineProperty(l, "name", {
                value: s
            });
        function ip(s, l, h) {
...
`, A = 0, B = [];
            ...
            for(var R = [
                ...
                y
            ], K = 0; K < s; ++K)B.push("arg" + K), R.push("argType" + K), G.push(l[K]), w += `  var arg${K} = argType${K}.readValueFromPointer(args${A ? "+" + A : ""});
`, A += l[K].Cb;
...
`), s = (function(ae) {
        ...
        var gi = (s)=>s % 4 == 0 && (s % 100 != 0 || s % 400 == 0), bi = [
            0,
            31,
            60,
            91,
        ...
        function wp(s, l, h, y) {
            s >>>= 0, l >>>= 0, h >>>= 0, y >>>= 0;
            var w = new Date().getFullYear(), A = new Date(w, 0, 1).getTimezoneOffset();
...
`))[0] == "Error" && y.shift(), xi(y);
        ...
        }, at.push(0, 1, void 0, 1, null, 1, !0, 1, !1, 1), n.count_emval_handles = ()=>at.length / 2 - 5 - yn.length;
        var Y, Mp = [
            fn,
            Mo,
            Lo,
        ...
        (async function() {
            ...
            kt ??= n.locateFile ? n.locateFile ? n.locateFile("ort-wasm-simd-threaded.jsep.wasm", _) : _ + "ort-wasm-simd-threaded.jsep.wasm" : new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort-wasm-simd-threaded.jsep.wasm (static in ecmascript)")).href;
            try {
        ...
        return n.stackSave = ()=>Pn(), n.stackRestore = (s)=>mr(s), n.stackAlloc = (s)=>kn(s), n.setValue = function(s, l, h = "i8") {
            ...
            if (0 < Pt) Lt = s;
                ...
                0 < Pt ? Lt = s : (n.calledRun = !0, te || (_t(), t(n)));
            }
        }(), n.PTR_SIZE = 4, o;
    }), Fp = Sa, qp = globalThis.self?.name?.startsWith("em-pthread");
    qp && Sa();
});
var Ea, Gn, jp, Ue, ka, Ln, Kp, Zp, Pa, Qp, Ca, za, Aa, Oa, _r = U(()=>{
    "use strict";
    yr();
    Ea = typeof location > "u" ? void 0 : location.origin, Gn = __TURBOPACK__import$2e$meta__.url > "file:" && __TURBOPACK__import$2e$meta__.url < "file;", jp = ()=>{
        if ("TURBOPACK compile-time truthy", 1) {
            if (Gn) {
                let e1 = URL;
                return new URL(new __turbopack_context__.U(__turbopack_context__.r("[project]/node_modules/onnxruntime-web/dist/ort.bundle.min.mjs (static in ecmascript)")).href, Ea).href;
            }
        ...
        try {
            let r = t ?? Ue;
            return (r ? new URL(e1, r) : new URL(e1)).origin === Ea;
        } catch  {
            return !1;
        }
    }, Kp = (e1, t)=>{
    ...
    }, Zp = (e1, t)=>`${t ?? "./"}${e1}`, Pa = async (e1)=>{
        let r = await (await fetch(e1, {
            credentials: "same-origin"
        })).blob();
        return URL.createObjectURL(r);
    }, Qp = async (e1)=>(await import(/*webpackIgnore:true*/ e1)).default, Ca = (xa(), Ft($a)).default, za = async ()=>{
    ...
    }, Aa = (Ia(), Ft(Ta)).default, Oa = async (e1, t, r)=>{
        if (!e1 && !t && Aa && Ue && Ln(Ue)) return [
            void 0,
            Aa
        ];
        {
            let n = "ort-wasm-simd-threaded.jsep.mjs", o = e1 ?? Kp(n, t), i = !!1 && r && o && !Ln(o, t), a = i ? await Pa(o) : o ?? Zp(n, t);
            return [
                i ? a : void 0,
                await Qp(a)
            ];
...
var Hn, Fn, Ar, Ba, Yp, Xp, Jp, wr, fe, ht = U(()=>{
    "use strict";
    _r();
    Fn = !1, Ar = !1, Ba = !1, Yp = ()=>{
        ...
        let o = e1.wasmPaths, i = typeof o == "string" ? o : void 0, a = o?.mjs, u = a?.href ?? a, d = o?.wasm, c = d?.href ?? d, p = e1.wasmBinary, [m, f] = await Oa(u, i, r > 1), b = !1, g = [];
        if (t > 0 && g.push(new Promise((_)=>{
            ...
            f($).then((v)=>{
                Ar = !1, Fn = !0, Hn = v, _(), m && URL.revokeObjectURL(m);
            }, (v)=>{
                Ar = !1, Ba = !0, S(v);
            });
...
var Ne, Kt, pe, Er = U(()=>{
    ...
    ht();
    Ne = (e1, t)=>{
        let r = fe(), n = r.lengthBytesUTF8(e1) + 1, o = r._malloc(n);
        ...
        try {
            ...
            throw new Error(`${e1} ERROR_CODE: ${i}, ERROR_MESSAGE: ${u}`);
        } finally{
            t.stackRestore(r);
        }
    };
...
var Da, Ma = U(()=>{
    ...
    Da = (e1)=>{
        ...
        try {
            ...
            let i = 0;
            return e1?.tag !== void 0 && (i = Ne(e1.tag, n)), r = t._OrtCreateRunOptions(o.logSeverityLevel, o.logVerbosityLevel, !!o.terminate, i), r === 0 && pe("Can't create run options."), e1?.extra !== void 0 && Kt(e1.extra, "", new WeakSet, (a, u)=>{
...
var em, tm, rm, kr, nm, Ra, Ua = U(()=>{
    ...
    em = (e1)=>{
        ...
        fe()._OrtAddSessionConfigEntry(e1, o, i) !== 0 && pe(`Can't set a session config entry: ${t} - ${r}.`);
    }, nm = async (e1, t, r)=>{
        for (let n of t){
                ...
                case "webgpu":
                    if (o = "JS", typeof n != "string") {
                        ...
                        if (p?.preferredLayout) {
                            ...
                            kr(e1, "preferredLayout", p.preferredLayout, r);
                        }
                    }
                    break;
                case "wasm":
            ...
            await fe()._OrtAppendExecutionProvider(e1, a, d, c, u) !== 0 && pe(`Can't append execution provider: ${o}.`);
        }
    }, Ra = async (e1)=>{
        let t = fe(), r = 0, n = [], o = e1 || {};
        rm(o);
        try {
            ...
            return o.extra !== void 0 && Kt(o.extra, "", new WeakSet, (m, f)=>{
                kr(r, m, f, n);
            }), [
                r,
                n
...
var Mt, Ye, gt, Pr, Zt, zr, Or, qn, ee = U(()=>{
    "use strict";
    Mt = (e1)=>{
        switch(e1){
            case "int8":
    ...
    }, zr = (e1)=>e1 === "float32" || e1 === "float16" || e1 === "int32" || e1 === "int64" || e1 === "uint32" || e1 === "uint8" || e1 === "bool" || e1 === "uint4" || e1 === "int4", Or = (e1)=>e1 === "float32" || e1 === "float16" || e1 === "int32" || e1 === "int64" || e1 === "uint32" || e1 === "uint64" || e1 === "int8" || e1 === "uint8" || e1 === "bool" || e1 === "uint4" || e1 === "int4", qn = (e1)=>{
        switch(e1){
            case "none":
                return 0;
            case "cpu":
...
var Qt, jn = U(()=>{
    ...
    yr();
    Qt = async (e1)=>{
        if (typeof e1 == "string") if ("TURBOPACK compile-time falsy", 0) {
            "TURBOPACK unreachable";
        } else {
    ...
    Kn = class {
        ...
        static adjustPadsBasedOnAutoPad(t, r, n, o, i, a, u) {
            if (u) {
                ...
                for(let d = 0; d < t.length - 2; d++)e1.adjustPadAndReturnShape(t[d + (a ? 1 : 2)], r[d], n[d], o[d], i, d, d + t.length - 2, u);
            }
        }
        static computePoolOutputShape(t, r, n, o, i, a, u) {
            ...
            return e1.computeShapeHelper(t, r, d, n, o, i, a, u), d;
        }
        static computeConvOutputShape(t, r, n, o, i, a, u) {
            ...
            return e1.computeShapeHelper(!1, t, d, n, o, i, a, u), d;
        }
        static computeShapeHelper(t, r, n, o, i, a, u, d) {
            if (t) for(let c = 0; c < r.length - 2; c++)n.push(1);
            else for(let c = 0; c < r.length - 2; c++)n.push(e1.adjustPadAndReturnShape(r[c + 2], o[c], i[c], a[c], u, c, c + r.length - 2, d));
        }
...
var Yn, Ha, sm, Ga, um, Fa, Rr, Ur, Qn, qa, ja = U(()=>{
    "use strict";
    Xe();
    Yn = (e1, t = !0)=>{
        if (e1.byteLength % 8 !== 0) throw new Error("Invalid Uint8Array length - must be a multiple of 8 (BigInt).");
        let r = e1.byteLength / 8, n = new BigInt64Array(e1.buffer, e1.byteOffset, r), o = new Int32Array(r);
        for(let i = 0; i < r; i++){
            let a = n[i];
        ...
        let r = e1.byteLength / 4, n = new Int32Array(e1.buffer, e1.byteOffset, r), o = BigInt64Array.from(n, BigInt);
        return t ? new Uint8Array(o.buffer) : o;
    }, sm = 1, Ga = ()=>sm++, um = new Map([
        [
            "float32",
            32
        ],
        ...
        constructor(t){
            ...
            let { sessionId: r, context: n, tensor: o, dataType: i, shape: a, shouldConvertInt64toInt32: u = !1 } = t;
        ...
        async ensureTensor(t, r, n, o) {
            ...
            return this.wrapper = await this.tensorManager.getCachedTensor(t, i, n, d, !0, !0, u), o && this.activeUpload && (this.wrapper.write(this.activeUpload), this.activeUpload = void 0), this.wrapper.tensor;
        }
        upload(t) {
            let r = t;
            if (this.wrapper) if (this.wrapper.shouldConvertInt64toInt32 && (r = Yn(t, !0), this.wrapper.setIsInt64ToInt32Converted(!0)), r.byteLength === this.wrapper.byteLength) {
        ...
        registerTensor(t, r, n, o) {
            let i = this.getMLContext(t), a = Ga(), u = new Rr({
                sessionId: t,
                context: i,
                tensor: r,
                dataType: n,
        ...
        async getCachedTensor(t, r, n, o, i, a, u = !1) {
...
var Xn, dm, Nr, Ka = U(()=>{
    ...
    Xn = new Map([
        ...
        registerMLContext(t, r) {
            ...
            n || (n = new Set, this.sessionIdsByMLContext.set(r, n)), n.add(t), this.temporaryGraphInputs.length > 0 && (this.sessionGraphInputs.set(t, this.temporaryGraphInputs), this.temporaryGraphInputs = []);
        }
        onReleaseSession(t) {
        ...
        async createTemporaryTensor(t, r, n) {
            ...
            await this.tensorManager.ensureTensor(t, i, o, n, !1);
        ...
        registerMLConstant(t, r, n, o, i, a, u = !1) {
            ...
            switch(i.dataType){
                ...
                case "uint32":
                    ...
                    break;
                case "int64":
                    u ? (m = Yn(new Uint8Array(p), !1), i.dataType = "int32") : m = new BigInt64Array(p);
                    break;
                case "uint64":
...
var Za, Jn, eo, lm, cm, Qa, ro, to, Xa, Ja = U(()=>{
    "use strict";
    Xe();
    Vr();
    Za = new Map([
    ...
    ]), Jn = [], eo = (e1)=>Math.ceil(Number(e1) / 16) * 16, lm = (e1)=>{
        for(let t = 0; t < Jn.length; t++){
            let r = Jn[t];
            if (e1 <= r) return r;
        }
        return Math.ceil(e1 / 16) * 16;
    }, cm = 1, Qa = ()=>cm++, ro = async (e1, t, r, n)=>{
        let o = eo(r), i = e1.device.createBuffer({
            size: o,
        ...
        upload(t, r) {
            ...
            p.copyBufferToBuffer(d, 0, u.gpuData.buffer, 0, a), this.backend.device.queue.submit([
                p.finish()
            ]), d.destroy(), se("verbose", ()=>`[WebGPU] GpuDataManager.upload(id=${t})`);
        }
        memcpy(t, r) {
        ...
        registerExternalBuffer(t, r, n) {
            ...
            return this.storageCache.set(o, {
                ...
                originalSize: r
            }), se("verbose", ()=>`[WebGPU] GpuDataManager.registerExternalBuffer(size=${r}) => id=${o}, registered.`), o;
        }
        ...
        create(t, r = GPUBufferUsage.STORAGE | GPUBufferUsage.COPY_SRC | GPUBufferUsage.COPY_DST) {
            ...
            }), se("verbose", ()=>`[WebGPU] GpuDataManager.create(size=${t}) => id=${u.id}`), u;
        }
        get(t) {
...
var It, io, be, Ae, N, ce, ao, Ct, He, F, Wr, P, M, es, Lr, oo, ts, ie = U(()=>{
    "use strict";
    ee();
    ne();
    It = 64, io = (e1, t)=>{
    ...
    }, ce = (e1)=>e1 % 4 === 0 ? 4 : e1 % 2 === 0 ? 2 : 1, ao = (e1 = "f32", t, r = "0")=>!t || t === 1 ? `${e1}(${r})` : `vec${t}<${e1}>(${r})`, Ct = (e1, t, r)=>e1 === "f32" ? r : t === 1 ? `f32(${r})` : `vec${t}<f32>(${r})`, He = (e1, t)=>t === 4 ? `(${e1}.x + ${e1}.y + ${e1}.z + ${e1}.w)` : t === 2 ? `(${e1}.x + ${e1}.y)` : t === 3 ? `(${e1}.x + ${e1}.y + ${e1}.z)` : e1, F = (e1, t, r, n)=>e1.startsWith("uniforms.") && r > 4 ? typeof t == "string" ? n === "f16" ? `${e1}[(${t}) / 8][(${t}) % 8 / 4][(${t}) % 8 % 4]` : `${e1}[(${t}) / 4][(${t}) % 4]` : n === "f16" ? `${e1}[${Math.floor(t / 8)}][${Math.floor(t % 8 / 4)}][${t % 8 % 4}]` : `${e1}[${Math.floor(t / 4)}][${t % 4}]` : r > 1 ? `${e1}[${t}]` : e1, Wr = (e1, t, r, n, o)=>{
        let i = typeof r == "number", a = i ? r : r.length, u = [
            ...new Array(a).keys()
        ], d = a < 2 ? "u32" : a <= 4 ? `vec${a}<u32>` : `array<u32, ${a}>`, c = io(t, o), p = typeof c == "string" ? c : c[1], m = typeof c == "string" ? c : c[0], f = {
            indices: d,
            value: p,
            storage: m,
            tensor: t
        }, b = (C)=>typeof C == "string" ? C : `${C}u`, g = {
            offsetToIndices: !1,
            indicesToOffset: !1,
            ...
            get: !1,
            getByIndices: !1
        }, _ = i ? "uniforms." : "", S = `${_}${e1}_shape`, $ = `${_}${e1}_strides`, v = "";
    ...
    `;
        ...
        let x = a < 2 ? "" : `
  fn o2i_${e1}(offset: u32) -> ${f.indices} {
    var indices: ${f.indices};
    var current = offset;
    ${v}
    return indices;
  }`, T = (C)=>(g.offsetToIndices = !0, a < 2 ? C : `o2i_${e1}(${C})`), E = [];
        if (a >= 2) for(let C = a - 1; C >= 0; C--)E.push(`${F($, C, a)} * (indices[${C}])`);
        let I = a < 2 ? "" : `
  fn i2o_${e1}(indices: ${f.indices}) -> u32 {
    return ${E.join("+")};
  }`, z = (C)=>(g.indicesToOffset = !0, a < 2 ? C : `i2o_${e1}(${C})`), O = (...C)=>a === 0 ? "0u" : `${f.indices}(${C.map(b).join(",")})`, D = (C, V)=>a < 2 ? `${C}` : `${F(C, V, a)}`, L = (C, V, de)=>a < 2 ? `${C}=${de};` : `${F(C, V, a)}=${de};`, q = {}, Q = (C, V)=>{
            g.broadcastedIndicesToOffset = !0;
            let de = `${V.name}broadcastedIndicesTo${e1}Offset`;
            ...
            return q[de] = `fn ${de}(outputIndices: ${V.type.indices}) -> u32 {
             return ${ze.length > 0 ? ze.join("+") : "0u"};
                ...
                if (f.storage === f.value) return `${e1}[${C}]=${V};`;
                if (f.storage === "vec2<u32>" && f.value === "i32") return `${e1}[${C}]=vec2<u32>(u32(${V}), select(0u, 0xFFFFFFFFu, ${V} < 0));`;
                if (f.storage === "vec2<u32>" && f.value === "u32") return `${e1}[${C}]=vec2<u32>(u32(${V}), 0u);`;
                if (f.storage === "u32" && f.value === "vec4<bool>") return `${e1}[${C}]=dot(vec4<u32>(0x1, 0x100, 0x10000, 0x1000000), vec4<u32>(${V}));`;
                throw new Error(`not supported combination of storage type ${f.storage} and value type ${f.value} yet`);
            })(), Z = (C)=>(()=>{
                if (f.storage === f.value) return `${e1}[${C}]`;
                if (f.storage === "vec2<u32>" && f.value === "i32") return `i32(${e1}[${C}].x)`;
                if (f.storage === "vec2<u32>" && f.value === "u32") return `u32(${e1}[${C}].x)`;
                if (f.storage === "u32" && f.value === "vec4<bool>") return `vec4<bool>(bool(${e1}[${C}] & 0xFFu), bool(${e1}[${C}] & 0xFF00u), bool(${e1}[${C}] & 0xFF0000u), bool(${e1}[${C}] & 0xFF000000u))`;
                throw new Error(`not supported combination of storage type ${f.storage} and value type ${f.value} yet`);
            })(), we = a < 2 ? "" : `
  fn get_${e1}ByIndices(indices: ${f.indices}) -> ${p} {
    return ${Z(`i2o_${e1}(indices)`)};
  }`, H = a < 2 ? "" : (()=>{
            let C = u.map((de)=>`d${de}: u32`).join(", "), V = u.map((de)=>`d${de}`).join(", ");
            return `
  fn get_${e1}(${C}) -> ${p} {
    return get_${e1}ByIndices(${O(V)});
  }`;
        })(), j = (...C)=>{
            if (C.length !== a) throw new Error(`indices length must be ${a}`);
            let V = C.map(b).join(",");
            return a === 0 ? Z("0u") : a === 1 ? Z(V[0]) : (g.get = !0, g.getByIndices = !0, g.indicesToOffset = !0, `get_${e1}(${V})`);
        }, te = (C)=>a < 2 ? Z(C) : (g.getByIndices = !0, g.indicesToOffset = !0, `get_${e1}ByIndices(${C})`), X = a < 2 ? "" : `
  fn set_${e1}ByIndices(indices: ${f.indices}, value: ${p}) {
    ${W(`i2o_${e1}(indices)`, "value")}
  }`, ue = a < 2 ? "" : (()=>{
            let C = u.map((de)=>`d${de}: u32`).join(", "), V = u.map((de)=>`d${de}`).join(", ");
            return `
  fn set_${e1}(${C}, value: ${p}) {
    set_${e1}ByIndices(${O(V)}, value);
  }`;
        })();
        return {
            impl: ()=>{
                let C = [], V = !1;
                return g.offsetToIndices && (C.push(x), V = !0), g.indicesToOffset && (C.push(I), V = !0), g.broadcastedIndicesToOffset && (Object.values(q).forEach((de)=>C.push(de)), V = !0), g.set && (C.push(ue), V = !0), g.setByIndices && (C.push(X), V = !0), g.get && (C.push(H), V = !0), g.getByIndices && (C.push(we), V = !0), !i && V && C.unshift(`const ${S} = ${f.indices}(${r.join(",")});`, `const ${$} = ${f.indices}(${k.computeStrides(r).join(",")});`), C.join(`
`);
            },
            type: f,
            offsetToIndices: T,
            ...
            set: (...C)=>{
                ...
                return a === 0 ? W("0u", V) : a === 1 ? W(de[0], V) : (g.set = !0, g.setByIndices = !0, g.indicesToOffset = !0, `set_${e1}(${de}, ${V})`);
            },
            setByOffset: W,
            setByIndices: (C, V)=>a < 2 ? W(C, V) : (g.setByIndices = !0, g.indicesToOffset = !0, `set_${e1}ByIndices(${C}, ${V});`),
            get: j,
            getByOffset: Z,
            getByIndices: te,
            usage: n,
    ...
    }, P = (e1, t, r, n = 1)=>Wr(e1, t, r, "input", n), M = (e1, t, r, n = 1)=>Wr(e1, t, r, "output", n), es = (e1, t, r)=>Wr(e1, t, r, "atomicOutput", 1), Lr = (e1, t, r, n = 1)=>Wr(e1, t, r, "internal", n), oo = class {
        constructor(t, r){
...
var pm, rs, mm, fm, hm, gm, Ee, ns, os, st = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    }, rs = (e1, t)=>t.length !== 0 ? t : [
            ...new Array(e1).keys()
        ].reverse(), mm = (e1, t)=>k.sortBasedOnPerm(e1, rs(e1.length, t)), fm = (e1, t, r, n)=>{
    ...
    var a: ${r.type.indices};`;
        ...
        let r = e1.dataType, n = e1.dims.length, o = rs(n, t), i = mm(e1.dims, o), a = e1.dims, u = i, d = n < 2 || gm(o, e1.dims), c;
        if (d) return c = (_)=>{
  ...
  ${_.mainStart()}
    ...
    output[global_idx] = input[global_idx];
        ...
        let { newShape: p, newPerm: m } = hm(e1.dims, o), f = k.areEqual(m, [
            2,
            3,
            1
        ]), b = k.areEqual(m, [
  ...
  ${_.mainStart()}
    ...
    ${$.setByOffset("global_idx", S.getByIndices("aIndices"))}
        ...
        pm(e1.inputs, t.perm), e1.compute(Ee(e1.inputs[0], t.perm));
    }, os = (e1)=>J({
            perm: e1.perm
        });
});
var bm, ym, _m, wm, vm, $m, xm, Sm, Tm, Im, et, is, as, ss, us, ds, ls, cs, ps, ms, fs, hs = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    ...
    bm = {
       ...
       `, g = (_)=>`
        ...
        let o = e1.inputs.length === 1 ? r : so(e1.inputs, r), i = o.axes;
        i.length === 0 && !o.noopWithEmptyAxes && (i = e1.inputs[0].dims.map((b, g)=>g));
        let a = k.normalizeAxes(i, e1.inputs[0].dims.length), u = a, d = e1.inputs[0], c = Tm(u, e1.inputs[0].dims.length);
        c.length > 0 && (d = e1.compute(Ee(e1.inputs[0], c), {
            inputs: [
                0
            ],
            outputs: [
        ...
        })[0], u = vm(u.length, d.dims.length));
        let [p, m] = $m(d.dims, u), f = p;
        o.keepDims && (f = xm(p, a)), e1.compute(Im(t, o.cacheKey, [
            d
        ], n, e1.inputs[0].dataType, f, m), {
            inputs: [
                d
            ]
        });
    }, is = (e1, t)=>{
        et(e1, "ReduceMeanShared", t, "mean");
    }, as = (e1, t)=>{
        et(e1, "ReduceL1Shared", t, "l1");
    }, ss = (e1, t)=>{
        et(e1, "ReduceL2Shared", t, "l2");
    }, us = (e1, t)=>{
        et(e1, "ReduceLogSumExpShared", t, "logSumExp");
    }, ds = (e1, t)=>{
        et(e1, "ReduceMaxShared", t, "max");
    }, ls = (e1, t)=>{
        et(e1, "ReduceMinShared", t, "min");
    }, cs = (e1, t)=>{
        et(e1, "ReduceProdShared", t, "prod");
    }, ps = (e1, t)=>{
        et(e1, "ReduceSumShared", t, "sum");
    }, ms = (e1, t)=>{
        et(e1, "ReduceSumSquareShared", t, "sumSquare");
    }, fs = (e1, t)=>{
        et(e1, "ReduceLogSumShared", t, "logSum");
    };
});
var tt, Cm, Hr, so, rt, Am, Em, km, Pm, zm, Om, Bm, Dm, Mm, Rm, nt, gs, bs, ys, _s, ws, vs, $s, xs, Ss, Ts, Gr = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
...
`)}
        ...
        let r = [];
        return e1[1].dims[0] > 0 && e1[1].getBigInt64Array().forEach((n)=>r.push(Number(n))), J({
            axes: r,
            keepDims: t.keepDims,
            noopWithEmptyAxes: t.noopWithEmptyAxes
        });
    }, rt = (e1, t, r, n)=>{
        let o = e1.inputs, i = o.length === 1 ? r : so(o, r);
        e1.compute(Hr(t, {
            hint: i.cacheKey,
            inputDependencies: [
                "rank"
            ...
            o[0]
        ], i.noopWithEmptyAxes && i.axes.length === 0 ? Cm : n, i.axes, o[0].dataType, i.keepDims, i.noopWithEmptyAxes), {
            inputs: [
                0
            ]
        });
    }, Am = (e1, t)=>{
        tt(e1.inputs), rt(e1, "ReduceLogSum", t, (n, o)=>[
        ...
        tt(e1.inputs), rt(e1, "ReduceL1", t, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
        ...
        tt(e1.inputs), rt(e1, "ReduceL2", t, (n, o)=>[
        ...
        tt(e1.inputs), rt(e1, "ReduceLogSumExp", t, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
        ...
        tt(e1.inputs), rt(e1, "ReduceMax", t, (n, o, i)=>{
            let a = [];
...
`)}`,
        ...
        tt(e1.inputs), rt(e1, "ReduceMean", t, (n, o, i)=>{
            let a = 1;
            for(let u = 0; u < n.rank; u++)(i.indexOf(u) >= 0 || i.length === 0) && (a *= e1.inputs[0].dims[u]);
            return [
                "var sum = f32(0);",
                "",
        ...
        tt(e1.inputs), rt(e1, "ReduceMin", t, (n, o, i)=>{
            let a = [];
...
`)}`,
        ...
        tt(e1.inputs), rt(e1, "ReduceProd", t, (n, o)=>[
        ...
        tt(e1.inputs), rt(e1, "ReduceSum", t, (n, o)=>[
                `var value = ${o.type.storage}(0);`,
                "",
                `value += ${n.getByIndices("input_indices")};`,
                ""
        ...
        tt(e1.inputs), rt(e1, "ReduceSumSquare", t, (n, o)=>[
                `var t = ${o.type.value}(0); var value = ${o.type.value}(0);`,
                "",
                `t = ${n.getByIndices("input_indices")}; value += t * t;`,
                ""
        ...
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Om(e1, t) : is(e1, t);
    }, bs = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Em(e1, t) : as(e1, t);
    }, ys = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? km(e1, t) : ss(e1, t);
    }, _s = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Pm(e1, t) : us(e1, t);
    }, ws = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? zm(e1, t) : ds(e1, t);
    }, vs = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Bm(e1, t) : ls(e1, t);
    }, $s = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Dm(e1, t) : cs(e1, t);
    }, xs = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Mm(e1, t) : ps(e1, t);
    }, Ss = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Rm(e1, t) : ms(e1, t);
    }, Ts = (e1, t)=>{
        nt(e1.inputs[0].dims, t.axes, t.noopWithEmptyAxes) ? Am(e1, t) : fs(e1, t);
    };
});
var Is, Cs, As, uo, Es = U(()=>{
    "use strict";
    ee();
    Se();
    Gr();
...
var Um, lo, Nm, Vm, Wm, Rt, Lm, ks, Fr = U(()=>{
    "use strict";
    ee();
    ne();
    Vr();
    ie();
    Um = (e1, t)=>{
        let r = e1[0], n = e1[1], o = e1[2], i = e1[3], a = e1[4], u = e1[5];
        ...
        return {
            ...
            hiddenSize: m,
            vHiddenSize: b,
            headSize: Math.floor(m / t.numHeads),
    ...
    `, Nm = (e1, t, r, n, o, i, a, u)=>{
        ...
        ], b = be(e1.dataType, d), g = Ae(1, d), _ = [
            "type"
        ];
        a && _.push("type"), u && _.push("type");
        let S = ($)=>{
            let v = M("x", e1.dataType, e1.dims, d), x = [
                v
            ], T = a ? P("seq_lens", a.dataType, a.dims) : void 0;
            T && x.push(T);
            let E = u ? P("total_sequence_length_input", u.dataType, u.dims) : void 0;
            E && x.push(E);
            let I = Ae(e1.dataType), z = [
                {
                    name: "batch_size",
                    type: "u32"
                },
  ...
  ${$.mainStart([
    ...
    if (sum == 0) {
      ...
      ${a ? `
    ...
    }, Vm = (e1, t, r, n, o, i, a, u, d)=>{
        let c = a + i.kvSequenceLength, p = [
            i.batchSize,
            i.numHeads,
            i.sequenceLength,
            c
        ], m = e1 > 1 && n, f = i.kvNumHeads ? i.kvNumHeads : i.numHeads, b = m ? [
            i.batchSize,
            f,
            c,
            i.headSize
        ] : void 0, g = i.nReps ? i.nReps : 1, _ = i.scale === 0 ? 1 / Math.sqrt(i.headSize) : i.scale, S = ce(i.headSize), $ = i.headSize / S, v = 12, x = {
            x: Math.ceil(c / v),
        ...
        let O = (D)=>{
            let L = P("q", t.dataType, t.dims, S), q = P("key", r.dataType, r.dims, S), Q = [
                L,
                q
            ];
            if (E) {
            ...
            Z && Q.push(Z);
            let we = M("output", t.dataType, p), H = [
                we
            ];
  ...
  ${D.mainStart([
    ...
    if (global_id.y < uniforms.M && global_id.x < total_sequence_length) {
      ...
      var sum: f32 = ${(()=>{
    ...
    }, Wm = (e1, t, r, n, o, i, a = void 0, u = void 0)=>{
        let d = i + o.kvSequenceLength, c = o.nReps ? o.nReps : 1, p = o.vHiddenSize * c, m = e1 > 1 && n, f = o.kvNumHeads ? o.kvNumHeads : o.numHeads, b = m ? [
            o.batchSize,
            f,
            d,
            o.headSize
        ...
        let E = (I)=>{
            let z = P("probs", t.dataType, t.dims), O = P("v", r.dataType, r.dims), D = [
                z,
                O
            ];
  ...
  ${I.mainStart([
   ...
   if (m < uniforms.M && n < uniforms.N) {
     ...
     output[outputIdx] = value;
    ...
    }, Rt = (e1, t, r, n, o, i, a, u, d, c, p = void 0, m = void 0)=>{
        let f = Math.min(e1.outputCount, 1 + (a ? 1 : 0) + (u ? 1 : 0)), b = f > 1 ? c.pastSequenceLength : 0, g = b + c.kvSequenceLength, _ = d && k.size(d.dims) > 0 ? d : void 0, S = [
            t,
            r
        ];
        f > 1 && a && k.size(a.dims) > 0 && S.push(a), _ && S.push(_), p && S.push(p), m && S.push(m);
        let $ = e1.compute(Vm(f, t, r, a, _, c, b, p, m), {
            inputs: S,
            outputs: f > 1 ? [
                -1,
                1
        ...
        e1.compute(Nm($, c.batchSize, c.numHeads, b, c.sequenceLength, g, p, m), {
            inputs: p && m ? [
                $,
                p,
                m
        ...
        f > 1 && u && k.size(u.dims) > 0 && v.push(u), p && v.push(p), m && v.push(m), e1.compute(Wm(f, $, n, u, c, b, p, m), {
            inputs: v,
            outputs: f > 1 ? [
                0,
                2
        ...
        let r = [
            ...
            t.sequenceLength,
            t.headSize
        ], n = t.sequenceLength, o = t.inputHiddenSize, i = t.headSize, a = 12, u = {
            ...
            let f = M("output_q", d[0].dataType, r), b = M("output_k", d[0].dataType, r), g = M("output_v", d[0].dataType, r), _ = P("input", d[0].dataType, d[0].dims), S = P("weight", d[1].dataType, d[1].dims), $ = P("bias", d[2].dataType, d[2].dims), v = _.type.storage, x = [
                {
                    name: "M",
                    type: "u32"
                },
...
var Gm, Hm, Fm, Ps, zs = U(()=>{
    ...
    Gm = (e1, t)=>{
        ...
        let { epsilon: r, spatial: n, format: o } = t, i = e1[0].dims, a = n ? ce(i[i.length - 1]) : 1, u = o === "NHWC" && i.length > 1 ? a : 1, d = k.size(i) / a, c = n, p = c ? i.length : i, m = P("x", e1[0].dataType, e1[0].dims, a), f = P("scale", e1[1].dataType, e1[1].dims, u), b = P("bias", e1[2].dataType, e1[2].dims, u), g = P("inputMean", e1[3].dataType, e1[3].dims, u), _ = P("inputVar", e1[4].dataType, e1[4].dims, u), S = M("y", e1[0].dataType, p, a), $ = ()=>{
            let x = "";
  ...
  ${x.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.outputSize")}
    ...
    ${S.setByOffset("global_idx", "value")}
        ...
        let { inputs: r, outputCount: n } = e1, o = Fm({
            ...t,
            outputCount: n
        });
...
var qm, jm, Os, Bs = U(()=>{
    ...
    qm = (e1)=>{
        ...
        let t = e1[0].dims, r = e1[0].dims[2], n = k.size(t) / 4, o = e1[0].dataType, i = P("input", o, t, 4), a = P("bias", o, [
            r
        ], 4), u = P("residual", o, t, 4), d = M("output", o, t, 4);
        return {
            name: "BiasAdd",
            getRunData: ()=>({
                    outputs: [
  ...
  ${p.mainStart()}
    ...
    ${d.setByOffset("global_idx", "value")}
        ...
        qm(e1.inputs), e1.compute(jm(e1.inputs));
    };
});
var Km, me, Ds, Ms, Rs, Us, Ns, Vs, Ws, Ls, Gs, Zm, Hs, Fs, qs, js, Yt, Ks, qr, Zs, Qs, Ys, Xs, Js, eu, tu, ru, nu, ou, iu, au, su, uu, du, lu, cu, pu, co, po, mu, fu, hu, Qm, Ym, gu, jr = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    Km = (e1, t, r, n, o, i, a)=>{
        ...
        return a && m.push(...a), `
      ${e1.registerUniforms(m).declareVariables(c, p)}
  ...
  ${e1.mainStart()}
    ...
    ${p.setByOffset("global_idx", d)}
    ...
    }, me = (e1, t, r, n, o, i = e1.dataType, a, u)=>{
        let d = [
            {
                type: 12,
        ...
        return a && d.push(...a), {
            ...
            getShaderSource: (c)=>Km(c, k.size(e1.dims), e1.dataType, i, r, n, u),
            getRunData: (c)=>({
                    outputs: [
                        {
                            dims: e1.dims,
                    ...
                    dispatchGroup: {
                        x: Math.ceil(k.size(c[0].dims) / 64 / 4)
                    },
                    programUniforms: d
                })
        };
    }, Ds = (e1)=>{
        e1.compute(me(e1.inputs[0], "Abs", "abs"));
    }, Ms = (e1)=>{
        e1.compute(me(e1.inputs[0], "Acos", "acos"));
    }, Rs = (e1)=>{
        e1.compute(me(e1.inputs[0], "Acosh", "acosh"));
    }, Us = (e1)=>{
        e1.compute(me(e1.inputs[0], "Asin", "asin"));
    }, Ns = (e1)=>{
        e1.compute(me(e1.inputs[0], "Asinh", "asinh"));
    }, Vs = (e1)=>{
        e1.compute(me(e1.inputs[0], "Atan", "atan"));
    }, Ws = (e1)=>{
        e1.compute(me(e1.inputs[0], "Atanh", "atanh"));
    }, Ls = (e1)=>J(e1), Gs = (e1, t)=>{
        let r;
        switch(t.to){
            case 10:
        ...
        e1.compute(me(e1.inputs[0], "Cast", r, void 0, t.cacheKey, t.to));
    }, Zm = (e1)=>{
        ...
        let r = t || Zm(e1.inputs), n = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "Clip", (o)=>`clamp(${o}, vec4<${n}>(uniforms.min), vec4<${n}>(uniforms.max))`, void 0, r.cacheKey, void 0, [
            {
        ...
        e1.compute(me(e1.inputs[0], "Ceil", "ceil"));
    }, qs = (e1)=>{
        e1.compute(me(e1.inputs[0], "Cos", "cos"));
    }, js = (e1)=>{
        e1.compute(me(e1.inputs[0], "Cosh", "cosh"));
    }, Yt = (e1)=>J(e1), Ks = (e1, t)=>{
        let r = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "Elu", (n)=>`elu_vf32(${n})`, `
...
fn erf_vf32(v: vec4<${e1}>) -> vec4<${e1}> {
  ...
  return sign(v) * (1.0 - ((((r5 * x + r4) * x + r3) * x + r2) * x + r1) * x * exp(-absv * absv));
        ...
        let t = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "Erf", (r)=>`erf_vf32(${r})`, qr(t)));
    }, Qs = (e1)=>{
        e1.compute(me(e1.inputs[0], "Exp", "exp"));
    }, Ys = (e1)=>{
        e1.compute(me(e1.inputs[0], "Floor", "floor"));
    }, Xs = (e1)=>{
        let t = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "Gelu", (r)=>`0.5 * ${r} * (1.0 + erf_vf32(${r} * 0.7071067811865475))`, qr(t)));
    }, Js = (e1, t)=>{
        let r = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "LeakyRelu", (n)=>`select(leaky_relu_alpha_ * ${n}, ${n}, ${n} >= vec4<${r}>(0.0))`, `const leaky_relu_alpha_ = ${r}(${t.alpha});`, t.cacheKey));
    }, eu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Not", (t)=>`!${t}`));
    }, tu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Neg", (t)=>`-${t}`));
    }, ru = (e1)=>{
        e1.compute(me(e1.inputs[0], "Reciprocal", (t)=>`1.0/${t}`));
    }, nu = (e1)=>{
        let t = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "Relu", (r)=>`select(vec4<${t}>(0.0), ${r}, ${r} > vec4<${t}>(0.0))`));
    }, ou = (e1)=>{
        e1.compute(me(e1.inputs[0], "Sigmoid", (t)=>`(1.0 / (1.0 + exp(-${t})))`));
    }, iu = (e1)=>J(e1), au = (e1, t)=>{
        let r = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "HardSigmoid", (n)=>`max(vec4<${r}>(0.0), min(vec4<${r}>(1.0), ${t.alpha} * ${n} + vec4<${r}>(${t.beta})))`, void 0, t.cacheKey));
    }, su = (e1)=>{
        e1.compute(me(e1.inputs[0], "Sin", "sin"));
    }, uu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Sinh", "sinh"));
    }, du = (e1)=>{
        e1.compute(me(e1.inputs[0], "Sqrt", "sqrt"));
    }, lu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Tan", "tan"));
    }, cu = (e1)=>`sign(${e1}) * (1 - exp(-2 * abs(${e1}))) / (1 + exp(-2 * abs(${e1})))`, pu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Tanh", cu));
    }, co = (e1 = "f32")=>`
...
`, po = (e1)=>`(fast_gelu_a + fast_gelu_a * tanh_v(${e1} * (fast_gelu_c * ${e1} * ${e1} + fast_gelu_b))) * ${e1}`, mu = (e1)=>{
        let t = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "FastGelu", po, co(t), void 0, e1.inputs[0].dataType));
    }, fu = (e1, t)=>{
        let r = Ae(e1.inputs[0].dataType);
        return e1.compute(me(e1.inputs[0], "ThresholdedRelu", (n)=>`select(vec4<${r}>(0.0), ${n}, ${n} > thresholded_relu_alpha_)`, `const thresholded_relu_alpha_ = vec4<${r}>(${t.alpha});`, t.cacheKey)), 0;
    }, hu = (e1)=>{
        e1.compute(me(e1.inputs[0], "Log", "log"));
    }, Qm = (e1, t)=>`
...
`, Ym = (e1)=>`quick_gelu_impl(${e1})`, gu = (e1, t)=>{
        let r = Ae(e1.inputs[0].dataType);
        e1.compute(me(e1.inputs[0], "QuickGelu", Ym, Qm(r, t.alpha), t.cacheKey, e1.inputs[0].dataType));
    };
});
var Xm, Jm, yu, _u = U(()=>{
    "use strict";
    ...
    Xm = (e1)=>{
        ...
        t[2] = t[2] / 2;
        let r = P("input", e1[0].dataType, e1[0].dims, 4), n = P("bias", e1[0].dataType, [
            e1[0].dims[2]
        ], 4), o = M("output", e1[0].dataType, t, 4), i = k.size(t) / 4, a = be(e1[0].dataType);
        return {
            name: "BiasSplitGelu",
            getRunData: ()=>({
                    outputs: [
  ...
  ${d.mainStart()}
    ...
    ${o.setByOffset("global_idx", "valueLeft * geluRight")}
        ...
        Xm(e1.inputs), e1.compute(Jm(e1.inputs));
    };
});
var ef, tf, ot, wu, vu, $u, xu, Su, Tu, Iu, Cu, Au, Eu, ku = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    ef = (e1, t, r, n, o, i, a, u, d, c, p, m)=>{
        let f, b;
        ...
        return `
        ${e1.registerUniform("vec_size", "u32").declareVariables(_, S, g)}
    ...
    }, tf = (e1, t, r, n, o, i, a = r.dataType)=>{
        let u = r.dims.map((_)=>Number(_) ?? 1), d = n.dims.map((_)=>Number(_) ?? 1), c = !k.areEqual(u, d), p = u, m = k.size(u), f = !1, b = !1, g = [
            c
        ];
        if (c) {
            let _ = Je.calcShape(u, d, !1);
            ...
            T % 4 === 0 ? (b = !0, f = !0) : (S || $ || v || x) && (f = !0);
        } else f = !0;
        return g.push(f), {
            name: e1,
            shaderCache: {
                hint: t + g.map((_)=>_.toString()).join("_"),
                inputDependencies: [
                    "rank",
                    "rank"
                ]
            },
            getShaderSource: (_)=>ef(_, u, d, p, f, c, b, o, r.dataType, n.dataType, a, i),
            getRunData: ()=>({
                    outputs: [
                        {
                            dims: p,
        ...
        e1.compute(tf(t, o ?? "", e1.inputs[0], e1.inputs[1], r, n, i));
    }, wu = (e1)=>{
        ot(e1, "Add", (t, r)=>`${t}+${r}`);
    }, vu = (e1)=>{
        ot(e1, "Div", (t, r)=>`${t}/${r}`);
...
`);
        ...
        let o = k.size(r), i = new Array(e1.length), a = new Array(e1.length), u = 0, d = [], c = [], p = [
            {
                type: 12,
                data: o
            }
        ];
        for(let _ = 0; _ < e1.length; ++_)u += e1[_].dims[t], i[_] = u, c.push(e1[_].dims.length), a[_] = P(`input${_}`, n, c[_]), d.push("rank"), p.push({
            type: 12,
            data: i[_]
        });
        for(let _ = 0; _ < e1.length; ++_)p.push(...N(e1[_].dims));
        p.push(...N(r));
  ...
  ${(()=>{
                ...
                for(let S = 0; S < e1.length; S++)_.registerUniform(`sizeInConcatAxis${S}`, "u32");
  ...
  ${_.mainStart()}
    ...
    ${af(a, m)}
        ...
        e1.compute(sf(a, o, i, r[0].dataType), {
            inputs: a
        });
    }, zu = (e1)=>J({
            axis: e1.axis
...
var Xt, Qr, Yr = U(()=>{
    ...
    Xt = (e1, t, r, n, o)=>{
      ...
      if (${F(t.shape, u, t.rank)} != 1) {
        ${t.indicesSet(e1, u, F(o, u + i, n))}
      } else {
        ${t.indicesSet(e1, u, 0)}
      }`).join("")}
`;
    }, Qr = (e1, t, r, n, o = !1, i)=>{
        let a = e1[0].dims, u = e1[1].dims, d = a[a.length - 2], c = u[u.length - 1], p = a[a.length - 1], m = ce(c), f = ce(p), b = ce(d), g = k.size(r) / m / b, _ = e1.length > 2, S = n ? n.slice(0, -2) : r.slice(0, -2), v = [
            k.size(S),
            d,
            c
        ], x = [
        ...
        qe(t, x), x.push(...N(S, a, u)), _ && x.push(...N(e1[2].dims)), x.push(...N(v));
        let T = (E)=>{
            let I = Lr("batch_dims", e1[0].dataType, S.length), z = P("a", e1[0].dataType, a.length, f), O = P("b", e1[1].dataType, u.length, m), D = M("output", e1[0].dataType, v.length, m), L = be(D.type.tensor), q = Fe(t, D.type.value, L), Q = [
                z,
                O
            ], W = "";
            if (_) {
                let H = o ? m : 1;
                Q.push(P("bias", e1[2].dataType, e1[2].dims.length, H)), W = `${o ? `value += bias[col / ${H}];` : `value += ${D.type.value}(bias[row + i]);`}`;
            }
            let Z = [
                {
                    name: "output_size",
...
var uf, df, mo, Ru, lf, fo, cf, Jt, Xr = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    ...
    uf = (e1, t)=>e1 ? `
        ...
        }`, mo = (e1, t, r = "f32", n, o = !1, i = 32, a = !1, u = 32)=>{
        let d = t[1] * e1[1], c = t[0] * e1[0], p = o ? d : i, m = o ? i : d, f = p / t[0], b = i / t[1];
        if (!((o && f === 4 && e1[1] === 4 || !o && (f === 3 || f === 4)) && p % t[0] === 0 && i % t[1] === 0 && e1[0] === 4)) throw new Error(`If transposeA ${o} is true, innerElementSize ${f} and workPerThread[1] ${e1[1]} must be 4.
      Otherwise, innerElementSize ${f} must be 3 or 4.
  tileAWidth ${p} must be divisible by workgroupSize[0]${t[0]}. tileInner ${i} must be divisible by workgroupSize[1] ${t[1]}. colPerThread ${e1[0]} must be 4.`);
        return `
var<workgroup> mm_Asub: array<array<vec${f}<${r}>, ${p / f}>, ${m}>;
var<workgroup> mm_Bsub: array<array<vec4<${r}>, ${c / e1[0]}>, ${i}>;
...
fn main(@builtin(local_invocation_id) localId : vec3<u32>,
  ...
  for (var innerRow = 0; innerRow < rowPerThread; innerRow = innerRow + 1) {
      mm_write(batch, globalRow + innerRow, globalCol, acc[innerRow]);
            ...
            `, lf = (e1)=>e1 ? "let ACached = mm_Asub[k][tileRow + innerRow];" : "let ACached = mm_Asub[tileRow + innerRow][k];", fo = (e1, t, r = "f32", n, o = !1, i = 32, a = !1, u = 32, d = !1)=>{
        let c = e1[1] * t[1], p = e1[0] * t[0], m = o ? c : i, f = o ? i : c;
...
`;
        ...
        return `
    fn mm_readA(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${Ie(e1, c)} {
      var value = ${Ie(e1, c)}(0.0);
      let col = colIn * ${e1};
    ...
    fn mm_readB(batch: i32, row: i32, colIn: i32, batchIndices: ${i.type.indices}) -> ${Ie(e1, c)} {
      var value = ${Ie(e1, c)}(0.0);
      let col = colIn * ${e1};
    ...
    fn mm_write(batch: i32, row: i32, colIn: i32, valueIn: ${Ie(e1, c)}) {
      let col = colIn * ${e1};
      if (row < uniforms.dim_a_outer && col < uniforms.dim_b_outer) {
        var value = valueIn;
        let coords = vec3<i32>(batch, row, colIn);
        ${t ? `value = value + ${o ? "bias[colIn]" : `${Ie(e1, c)}(bias[row])`};` : ""}
        ${r}
    ...
    `;
        ...
        let a = e1[0].dims, u = e1[1].dims, d = a.slice(0, -2), c = u.slice(0, -2), p = n ? n.slice(0, -2) : r.slice(0, -2), m = k.size(p), f = a[a.length - 2], b = a[a.length - 1], g = u[u.length - 1], _ = b % 4 === 0 && g % 4 === 0, S = f <= 8 ? [
            4,
            1,
            1
        ] : [
        ...
        q && (D.push(...N(e1[2].dims)), L.push("rank")), D.push(...N(O));
        let Q = (W)=>{
            let Z = p.length, we = Lr("batchDims", e1[0].dataType, Z, 1), H = be(e1[0].dataType), j = P("a", e1[0].dataType, E, x), te = P("b", e1[1].dataType, z, x), X = M("result", e1[0].dataType, O.length, x), ue = [
                j,
                te
            ];
            if (q) {
                let V = o ? x : 1;
                ue.push(P("bias", e1[2].dataType, e1[2].dims.length, V));
            }
            let he = [
                {
                    name: "dim_a_outer",
            ...
            je(t, he);
            let ye = be(X.type.tensor), re = Fe(t, X.type.value, ye), C = cf(x, q, re, [
                we,
                j,
                te,
                X
...
var pf, Uu, Nu = U(()=>{
    ...
    Mu();
    Xr();
    pf = (e1, t, r, n, o = !1, i, a = 4, u = 4, d = 4, c = "f32")=>{
        let p = (L)=>{
            switch(L){
                case 1:
    ...
    let coords = vec4<i32>(
      ...
      col / outWidth,
      col % outWidth);
    `, g = e1 ? "i32(uniforms.x_shape[1])" : "i32(uniforms.x_shape[2])", _ = e1 ? "i32(uniforms.x_shape[2])" : "i32(uniforms.x_shape[3])", S = e1 ? "row" : "col", $ = e1 ? "col" : "row", v = `
    ...
    return ${Ie(a, c)}(0.0);`, T = e1 ? n && r ? m(u) : `
    let col = colIn * ${u};
    if (row < uniforms.dim_inner && col < uniforms.dim_b_outer) {
      ${m(u)}
    }
    ...
    return ${Ie(u, c)}(0.0);`, E = Ie(d, c), I = e1 ? Ie(a, c) : Ie(u, c), z = e1 ? Ie(u, c) : Ie(a, c), O = Fe(i, E, c);
        return `
    ...
    fn mm_write(batch: i32, row : i32, colIn : i32, valueIn : ${E}) {
      ...
      setOutputAtCoords(coords[0], coords[1], coords[2], coords[3], value);
    ...
    }, Uu = (e1, t, r, n, o, i, a, u, d)=>{
        let c = t.format === "NHWC", p = c ? e1[0].dims[3] : e1[0].dims[1], m = r[0], f = c ? r[2] : r[3], b = c ? r[1] : r[2], g = c ? r[3] : r[1], _ = c && (p % 4 === 0 || p % 3 === 0) && g % 4 === 0, S = c ? g : f * b, $ = c ? f * b : g, v = [
            8,
            8,
            1
        ], x = n <= 8 ? [
        ...
        let E = _ ? c && p % 4 !== 0 ? 3 : 4 : 1, I = v[1] * x[1], z = v[0] * x[0], O = Math.max(v[0] * E, v[1]), D = n % I === 0, L = o % z === 0, q = i % O === 0, Q = _ ? [
            E,
            4,
            4
        ] : [
        ...
        qe(t, W), W.push(...N(e1[0].dims, e1[1].dims));
        let Z = [
            "rank",
            "rank"
        ];
        a && (W.push(...N(e1[2].dims)), Z.push("rank")), W.push(...N(r));
        let we = (H)=>{
            let j = [
                {
                    name: "dim_a_outer",
            ...
            je(t, j);
            let te = _ ? 4 : 1, X = be(e1[0].dataType), ue = `
      ...
      fn setOutputAtCoords(d0 : i32, d1 : i32, d2 : i32, d3 : i32, value : ${_ ? `vec4<${X}>` : X}) {
      ...
      }`, he = P("x", e1[0].dataType, e1[0].dims.length, E === 3 ? 1 : E), ye = P("w", e1[1].dataType, e1[1].dims.length, te), re = [
                he,
                ye
            ], C = M("result", e1[0].dataType, r.length, te);
            if (a) {
                let V = P("bias", e1[2].dataType, e1[2].dims.length, te);
                re.push(V), ue += `
        ...
        ${_ ? mo(x, v, X, void 0, !c, O) : fo(x, v, X, void 0, !c, O, !1, void 0, u)}`;
        };
        return {
            name: "Conv2DMatMul",
            shaderCache: {
                hint: `${t.cacheKey};${E};${_};${D};${L};${q};${I};${z};${O}`,
                inputDependencies: Z
            },
            getRunData: ()=>({
                    outputs: [
...
var mf, Vu, Jr, ff, Wu, hf, Lu, Gu, Hu = U(()=>{
    "use strict";
    ee();
    Xe();
    ne();
    ...
    mf = (e1)=>{
        ...
        return t;
    }, Vu = (e1)=>typeof e1 == "number" ? [
            e1,
            e1,
            e1
        ] : e1, Jr = (e1, t)=>t <= 1 ? e1 : e1 + (e1 - 1) * (t - 1), ff = (e1, t, r, n = 1)=>{
        let o = Jr(t, n);
        return Math.floor((e1[0] * (r - 1) - r + o) / 2);
    }, Wu = (e1, t, r, n, o)=>{
        o == null && (o = ff(e1, t[0], n[0]));
        let i = [
            0,
            0,
            0,
        ...
        if (e1 === "VALID" && (e1 = 0), typeof e1 == "number") {
            ...
            if (!e1.every((_, S, $)=>_ === $[0])) throw Error(`Unsupported padding parameter: ${e1}`);
            p = {
                top: e1[0],
                bottom: e1[1],
                left: e1[2],
    ...
    }, Lu = (e1, t, r, n, o, i = !1, a = "channelsLast")=>{
        let u, d, c, p, m;
        if (a === "channelsLast") [u, d, c, p, m] = e1;
        else if (a === "channelsFirst") [u, m, d, c, p] = e1;
        else throw new Error(`Unknown dataFormat ${a}`);
        let [f, , b, g, _] = t, [S, $, v] = Vu(r), [x, T, E] = Vu(n), I = Jr(b, x), z = Jr(g, T), O = Jr(_, E), { padInfo: D, outDepth: L, outHeight: q, outWidth: Q } = hf(o, d, c, p, S, $, v, I, z, O), W = i ? f * m : f, Z = [
            0,
            0,
            0,
            0,
        ...
        let a = i === "channelsLast", u = a ? e1[0].dims[3] : e1[0].dims[1], d = !1, c = [
            64,
            1,
            1
        ], p = {
            ...
            Math.ceil(mf(p.x.map((v)=>r[v])) / c[0]),
            1,
            1
        ];
        se("verbose", ()=>`[conv3d_naive_webgpu] dispatch = ${m}`);
        let f = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 1, b = k.size(r), g = [
            {
                type: 12,
                data: b
            },
        ...
        qe(t, g), g.push(...N(e1[0].dims, e1[1].dims));
        let _ = [
            "rank",
            "rank"
        ], S = e1.length === 3;
        S && (g.push(...N(e1[2].dims)), _.push("rank")), g.push(...N(r));
        let $ = (v)=>{
            let x = [
                {
                    name: "output_size",
            ...
            je(t, x);
            let T = ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : 1, E = be(e1[0].dataType), I = P("x", e1[0].dataType, e1[0].dims.length, ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : f), z = P("W", e1[1].dataType, e1[1].dims.length, T), O = [
                I,
                z
            ], D = M("result", e1[0].dataType, r.length, T), L = "";
            if (S) {
                let W = P("bias", e1[2].dataType, e1[2].dims.length, T);
                O.push(W), L += `
        fn getBiasByOutputCoords(coords : array<u32, 5>) -> ${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : E} {
          return bias[${a ? F("coords", 4, 5) : F("coords", 1, 5)}${("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : ""}];
        }`;
            }
...
var Fu, qu, ju = U(()=>{
    ...
    bt();
    Fu = (e1, t, r, n)=>{
        let o = e1.length > 2, i = o ? "value += b[output_channel];" : "", a = e1[0].dims, u = e1[1].dims, d = t.format === "NHWC", c = d ? r[3] : r[1], p = c / t.group, m = d && p >= 4 ? ce(c) : 1, f = k.size(r) / m, b = [
            {
                type: 12,
                data: f
            },
        ...
        let _ = (S)=>{
            let $ = M("output", e1[0].dataType, r.length, m), v = be($.type.tensor), x = Fe(t, $.type.value, v), T = P("x", e1[0].dataType, a.length), E = P("w", e1[1].dataType, u.length, m), I = [
                T,
                E
            ];
            o && I.push(P("b", e1[2].dataType, e1[2].dims, m));
            let z = [
                {
                    name: "output_size",
                    type: "u32"
  ...
  ${S.mainStart()}
    ...
    ${$.setByOffset("global_idx", "value")}
        ...
        let o = e1.length > 2, i = ce(r[3]), a = ce(r[2]), u = k.size(r) / i / a, d = [
            e1[0].dims[0],
            e1[0].dims[1],
            e1[0].dims[2],
            e1[0].dims[3] / i
        ...
        let f = (a - 1) * t.strides[1] + c[1], b = (g)=>{
            let _ = M("output", e1[0].dataType, p.length, i), S = be(_.type.tensor), $ = Fe(t, _.type.value, S), v = P("x", e1[0].dataType, d.length, i), x = P("w", e1[1].dataType, c.length, i), T = [
                v,
                x
            ];
            o && T.push(P("b", e1[2].dataType, e1[2].dims, i));
            let E = o ? "value += b[output_channel];" : "", I = [
                {
                    name: "output_size",
                    type: "u32"
                },
...
var gf, ho, bf, go, bo, Ku, yf, _f, yo, Zu = U(()=>{
    "use strict";
    ne();
    Nu();
    Hu();
    ...
    st();
    gf = (e1, t, r, n, o, i)=>{
        let a = e1[0], u = e1.slice(i ? 1 : 2, i ? 3 : 4), d = u.length, c = t[0], m = t.slice(2).map((g, _)=>g + (g - 1) * (r[_] - 1)), b = u.map((g, _)=>g + n[_] + n[_ + d]).map((g, _)=>Math.floor((g - m[_] + o[_]) / o[_]));
        ...
        let n = e1.pads.slice();
        Tt.adjustPadsBasedOnAutoPad(t[0].dims, e1.strides, e1.dilations, r, n, e1.format === "NHWC", e1.autoPad);
        ...
        let t = Kr(e1), r = e1.format, n = [
            "NOTSET",
            "VALID",
            "SAME_UPPER",
            "SAME_LOWER"
        ][e1.auto_pad], o = e1.dilations, i = e1.group, a = e1.kernel_shape, u = e1.pads, d = e1.strides, c = e1.w_is_const();
        return {
            autoPad: n,
            format: r,
            dilations: o,
        ...
        if (r.group !== 1) {
            ...
            if (o) {
                let O = e1.kernelCustomData.wT ?? e1.compute(Ee(t[1], ho), {
                    inputs: [
                        1
                    ],
                    outputs: [
                ...
                r.wIsConst && !e1.kernelCustomData.wT && (e1.kernelCustomData.wT = O), I.push(O);
            } else I.push(t[1]);
            t.length === 3 && I.push(t[2]), !e1.adapterInfo.isArchitecture("ampere") && o && t[1].dims[0] === r.group && t[1].dims[1] === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 ? e1.compute(qu(I, r, i, n), {
                inputs: I
            }) : e1.compute(Fu(I, r, i, n), {
                inputs: I
            });
            return;
        }
        ...
        if (_ || p === 1 && m === 1 && r.dilations[0] === 1 && r.dilations[1] === 1 && r.strides[0] === 1 && r.strides[1] === 1 && r.pads[0] === 0 && r.pads[1] === 0) {
            let I = i[0], z, O, D, L = [];
            if (o) {
                let W = e1.kernelCustomData.wT ?? e1.compute(Ee(t[1], ho), {
                    inputs: [
                        1
                    ],
                    outputs: [
                ...
                if (r.wIsConst && !e1.kernelCustomData.wT && (e1.kernelCustomData.wT = W), _) {
                    let Z = u * d * c;
                    z = t[0].reshape([
                        1,
                        I,
            ...
            q < 8 && Q < 8 ? e1.compute(Qr(L, r, i, D, o, n), {
                inputs: L
            }) : e1.compute(Jt(L, r, i, D, o, n), {
                inputs: L
            });
            return;
        }
        let S = !0, $ = e1.kernelCustomData.wT ?? e1.compute(Ee(t[1], ho), {
            inputs: [
                1
            ],
            outputs: [
        ...
        e1.compute(Uu(v, r, i, x, T, E, a, S, n), {
            inputs: v
        });
    }, yf = (e1, t)=>{
        ...
        let n = r.format === "NHWC" ? "channelsLast" : "channelsFirst", o = go(r, t), i = r.autoPad === "NOTSET" ? r.pads : r.autoPad, a = Lu(t[0].dims, t[1].dims, r.strides, r.dilations, i, !1, n);
        e1.compute(Gu(t, o, a.outShape, [
            a.filterDepth,
            a.filterHeight,
            a.filterWidth
        ], [
        ...
        if (bf(e1.inputs, t), e1.inputs[0].dims.length === 3) yf(e1, t);
        else if (e1.inputs[0].dims.length === 5) _f(e1, e1.inputs, t);
        else {
            let r = go(t, e1.inputs);
            Ku(e1, e1.inputs, r);
        }
    };
});
var Qu, Yu = U(()=>{
    ...
    ie();
    Qu = (e1, t, r)=>{
        let n = e1.length > 2, o = t.outputShape, i = t.format === "NHWC", a = t.group, u = e1[1].dims, d = u[2] / a, c = u[3], p = i ? ce(d) : 1, m = i && c === 1 && d >= 4, f = m ? Math.floor(d / 4) * 4 : Math.floor(d / p) * p, b = d - f, g = i ? ce(c) : 1, _ = i ? c === 1 ? p : g : 1, S = k.size(o) / g, $ = [
            Math.ceil(S / 64),
            1,
            1
        ];
        ...
        let v = [
            ...
            T[0] + (t.dilations[0] <= 1 ? 0 : (t.kernelShape[i ? 1 : 2] - 1) * (t.dilations[0] - 1)),
            T[1] + (t.dilations[1] <= 1 ? 0 : (t.kernelShape[i ? 2 : 3] - 1) * (t.dilations[1] - 1))
        ], z = [
        ...
        n && (O.push(...N(e1[2].dims)), v.push("rank")), O.push(...N(o));
        let D = (L)=>{
            let q = [
                {
                    name: "output_size",
            ...
            ], Q = be(e1[0].dataType), W = i ? 1 : 2, Z = i ? 2 : 3, we = i ? 3 : 1, H = P("W", e1[1].dataType, e1[1].dims.length, _), j = P("Dy", e1[0].dataType, e1[0].dims.length, p), te = [
                j,
                H
            ];
            n && te.push(P("bias", e1[2].dataType, [
                o[we]
            ].length, g));
            let X = M("result", e1[0].dataType, o.length, g), ue = ()=>{
                let re = "";
                if (m) p === 4 ? re += `
...
var wf, vf, $f, Xu, Ju, xf, ed, Sf, td, rd = U(()=>{
    "use strict";
    Yu();
    bt();
    st();
    wf = (e1, t, r, n, o, i)=>(e1 - 1) * t + r + (n - 1) * o + 1 - i, vf = (e1, t, r, n, o)=>{
        let i = Math.floor(e1 / 2);
        t === "SAME_UPPER" ? (r[n] = i, r[o] = e1 - i) : t === "SAME_LOWER" && (r[n] = e1 - i, r[o] = i);
    }, $f = (e1, t, r, n, o, i, a, u, d, c)=>{
        let p = e1.length - 2, m = c.length === 0;
        d.length < p && d.push(...Array(p - d.length).fill(0));
        let f = e1[0], b = t[u ? 3 : 1] * o;
        for(let g = 0, _ = e1.length - p - (u ? 1 : 0); g < p; ++g, ++_){
            let S = e1[_], $ = m ? S * a[g] : c[g], v = wf(S, a[g], i[g], t[_], r[g], $);
            vf(v, n, i, g, g + p), m && c.push(a[g] * (S - 1) + d[g] + (t[_] - 1) * r[g] + 1 - i[g] - i[g + p]);
        }
        c.splice(0, 0, f), c.splice(u ? 3 : 1, 0, b);
    }, Xu = (e1, t)=>{
        let r = e1.kernelShape.slice();
        if (e1.kernelShape.length === 0 || e1.kernelShape.reduce((m, f)=>m * f, 1) === 0) {
            r.length = 0;
            for(let m = 2; m < t[1].dims.length; ++m)r.push(t[1].dims[m]);
        }
        let n = e1.format === "NHWC";
        r.splice(0, 0, t[1].dims[0]), r.splice(n ? 3 : 1, 0, t[1].dims[1]);
        let o = e1.pads.slice(), i = e1.outputShape.slice(), a = e1.outputPadding.slice(), u = t[0].dims, d = e1.dilations.slice();
        ...
        $f(u, r, d, e1.autoPad, e1.group, o, c, n, a, i);
        let p = Object.assign({}, e1);
        ...
        let t = Kr(e1), r = e1.format, n = [
            ...
            "SAME_UPPER",
            "SAME_LOWER"
        ][typeof e1.autoPad > "u" ? 0 : e1.autoPad], o = e1.dilations, i = e1.group, a = e1.kernelShape, u = e1.pads, d = e1.strides, c = e1.wIsConst(), p = e1.outputPadding, m = e1.outputShape;
        return {
            autoPad: n,
            format: r,
            dilations: o,
        ...
        if (t.kernelShape.reduce((p, m)=>p + m, 0) > 0 && t.kernelShape.length !== 0 && t.kernelShape.length !== e1[1].dims.length - 2) throw new Error("invalid kernel shape");
        if (t.outputShape.length !== 0 && t.outputShape.length !== e1[0].dims.length - 2) throw new Error("invalid output shape");
    }, ed = (e1, t, r, n)=>{
        let o = e1.kernelCustomData.wT ?? e1.compute(Ee(t[1], [
            2,
            3,
            0,
            1
        ...
        t.length === 3 && i.push(t[2]), e1.compute(Qu(i, r, n), {
            inputs: i
        });
    }, Sf = (e1, t)=>{
        let r = t.format === "NHWC", n = [
        ...
        if (xf(e1.inputs, t), e1.inputs[0].dims.length === 3) Sf(e1, t);
        else {
            let r = Xu(t, e1.inputs);
            ed(e1, e1.inputs, r);
        }
    };
});
var Tf, nd, od, id = U(()=>{
    ...
    ie();
    Tf = (e1, t, r, n)=>{
        let o = k.size(t), i = t.length, a = P("input", e1, i), u = M("output", e1, i), d = r.dataType === 6 ? r.getInt32Array()[0] : Number(r.getBigInt64Array()[0]), c = k.normalizeAxis(d, i), p = (m)=>{
...
`);
        ...
        let m = e1.reshape(a), f = m.dims.length, b = e1.dataType, g = P("a", b, f), _ = M("output", b, f), S = ($)=>`
  ...
  ${$.mainStart()}
    ...
    ${_.setByOffset("global_idx", g.getByIndices("aIndices"))}
        ...
        return {
            ...
            getRunData: ($)=>{
                let v = d ? [
                    ...
                    n * c,
                    o * c
                ], x = k.size(v), T = m.dims, E = k.sortBasedOnPerm(T, u);
                return {
                    outputs: [
                        {
                            dims: v,
        ...
        If(e1.inputs), e1.compute(Af(e1.inputs[0], t));
    }, sd = (e1)=>J({
...
var _o, en, dd, Ef, kf, wo, vo, ld, Pf, cd, pd, md = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    }, ld = (e1)=>e1 + "_max", Pf = (e1, t, r, n)=>{
        let i = e1.map((p)=>p.length).map((p, m)=>P(`input${m}`, t, p)), a = k.size(n), u = M("output", t, n.length), d = [
            ...r.symbolToInfo.keys()
        ].filter((p)=>!r.rhs.symbolToIndices.has(p)), c = (p)=>{
            ...
            let T = x ? [
                ...m,
                `let sum = ${i.map((E, I)=>E.getByIndices(`input${I}Indices`)).join(" * ")};`
            ] : [
                ...m,
                b,
                ...S,
...
`)};
        ...
        let r = new vo(e1.inputs, t.equation), n = r.outputDims, o = e1.inputs.map((i, a)=>i.dims);
        e1.compute(Pf(o, e1.inputs[0].dataType, r, n));
    }, pd = (e1)=>{
...
var zf, fd, Of, Bf, hd, gd = U(()=>{
    ...
    zf = (e1)=>{
        ...
        return n;
    }, Of = (e1, t)=>e1.length > t.length ? fd(e1, t) : fd(t, e1), Bf = (e1)=>{
        let t = e1[0].dims, r = Array.from(e1[1].getBigInt64Array(), Number), n = Of(t, r), o = e1[0].dataType, i = o === 9 || k.size(t) === 1, a = o === 9 || t.length > 0 && t[t.length - 1] % 4 === 0 ? 4 : 1, u = i || n.length > 0 && n[n.length - 1] % 4 === 0 ? 4 : 1, d = Math.ceil(k.size(n) / u), c = (m)=>{
    ...
    ${g}`;
        ...
        zf(e1.inputs), e1.compute(Bf(e1.inputs), {
            inputs: [
                0
            ]
        });
...
var Df, bd, yd = U(()=>{
    ...
    ${a.mainStart(It)}
      ...
      ${c.setByOffset("global_idx", po("x_in"))}
        ...
        e1.inputs.length < 2 || k.size(e1.inputs[1].dims) === 0 ? mu(e1) : e1.compute(Df(e1.inputs));
    };
});
var Mf, Rf, _d, wd, vd = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    Mf = (e1)=>{
        ...
        a.splice(i, 1, ...n);
        let u = r[i], d = e1[0].dataType === 9 ? 4 : 1, c = Math.ceil(k.size(a) / d), p = [
            {
                type: 12,
                data: c
            },
            ...
            let b = P("data", e1[0].dataType, e1[0].dims.length, d), g = P("inputIndices", e1[1].dataType, e1[1].dims.length), _ = M("output", e1[0].dataType, a.length, d), S = (v)=>{
      ...
      ${f.mainStart()}
        ...
        let r = e1.inputs;
        Mf(r), e1.compute(Rf(e1.inputs, t));
    };
});
var Uf, $d, xd, Sd = U(()=>{
    "use strict";
    ...
    Uf = (e1, t, r, n, o, i, a, u, d)=>{
        ...
        c.push(...N(t.dims, p));
        let m = (f)=>{
            let b = P("indices_data", t.dataType, t.dims.length), g = M("input_slice_offsets_data", 12, 1, 1), _ = [
                b,
                g
            ], S = [
                {
  ...
  ${f.mainStart()}
    ...
    input_slice_offsets_data[global_idx] =  base_offset + u32(relative_slice_offset);
        ...
        let r = e1.inputs, n = r[0].dims, o = r[0].dataType, i = r[1].dims, a = i[i.length - 1], u = k.sizeToDimension(i, i.length - 1), d = k.sizeFromDimension(n, t.batchDims + a), c = k.sizeToDimension(n, t.batchDims), p = k.sizeFromDimension(n, t.batchDims), m = u / c, f = new Array(a), b = d;
        for(let T = 0; T < a; ++T)f[a - 1 - T] = b, b *= n[t.batchDims + a - 1 - T];
        let g = Uf(e1, r[1], f, t.batchDims, n, u, m, p, a), _ = t.batchDims + a;
        if (_ > n.length) throw new Error("last dimension of indices must not be larger than rank of input tensor");
        let S = i.slice(0, -1).concat(n.slice(_)), $ = k.size(S), v = [
            {
                type: 12,
                data: $
            },
...
var Nf, Vf, Td, Id, Cd = U(()=>{
    ...
    Nf = (e1, t)=>{
        ...
        let r = k.normalizeAxis(t.quantizeAxis, e1[0].dims.length), n = t.blockSize, o = e1[0], i = e1[2], a = e1.length === 4 ? e1[3] : void 0;
        ...
        if (a) {
            ...
            if (a.dims.length !== i.dims.length || !a.dims.map((u, d)=>u === i.dims[d]).reduce((u, d)=>u && d, !0)) throw new Error("Zero point must have the same rank as the input tensor and the dims should match except on quantizeAxis.");
        }
    }, Vf = (e1, t)=>{
        let r = e1[0].dims, n = e1[1].dims, o = r.length, i = k.normalizeAxis(t.gatherAxis, o), a = k.normalizeAxis(t.quantizeAxis, o), u = r.slice(0);
        u.splice(i, 1, ...n);
        let d = k.size(u), c = e1[2].dataType, m = e1[0].dataType === 22, f = [
            {
                type: 12,
                data: d
            },
            ...
            ...N(...e1.map((g, _)=>g.dims), u)
        ], b = (g)=>{
            let _ = P("data", e1[0].dataType, e1[0].dims.length), S = P("inputIndices", e1[1].dataType, e1[1].dims.length), $ = P("scales", e1[2].dataType, e1[2].dims.length), v = e1.length > 3 ? P("zeroPoint", e1[3].dataType, e1[3].dims.length) : void 0, x = M("output", c, u.length), T = [
                _,
                S,
                $
            ];
        ...
        return {
            ...
            shaderCache: {
                hint: `${t.cacheKey};${e1.filter((g, _)=>_ !== 1).map((g)=>g.dims.join("_")).join(";")}`,
        ...
        let r = e1.inputs;
        Nf(r, t), e1.compute(Vf(e1.inputs, t));
    }, Id = (e1)=>J({
            blockSize: e1.blockSize,
...
var Wf, Lf, Ad, Ed, kd = U(()=>{
    ...
    Wf = (e1)=>{
        ...
        let r = e1[0].dims, n = e1[0].dataType, o = r.length, i = e1[1].dims, a = e1[1].dataType, u = k.normalizeAxis(t.axis, o), d = r[u], c = i.slice(0), p = k.size(c), m = P("input", n, o), f = P("indicesInput", a, i.length), b = M("output", n, c.length), g = [
            {
                type: 12,
                data: p
            },
      ...
      ${b.setByOffset("global_idx", "value")};
        ...
        let r = e1.inputs;
        Wf(r), e1.compute(Lf(e1.inputs, t));
    };
});
var Gf, Hf, Pd, zd, Od = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    Gf = (e1)=>{
        ...
        let r = e1[0].dims.slice(), n = e1[1].dims.slice(), [o, i, a] = Dr.getShapeOfGemmResult(r, t.transA, n, t.transB, e1.length === 3 ? e1[2].dims : void 0), u = [
            o,
            i
        ];
        if ("TURBOPACK compile-time falsy", 0) {
        ...
        let d = 16, c = Math.ceil(i / d), p = Math.ceil(o / d), m = !0, f = k.size(u), b = [
            {
                type: 12,
                data: ("TURBOPACK compile-time truthy", 1) ? c : ("TURBOPACK unreachable", undefined)
            },
            {
                type: 12,
                data: o
        ...
        e1.length === 3 && (b.push(...N(e1[2].dims)), g.push("rank")), b.push(...N(u));
        let _ = ($)=>{
            let v = "";
            ...
            let x = t.alpha === 1 ? "" : "value *= uniforms.alpha;", T = P("a", e1[0].dataType, e1[0].dims), E = P("b", e1[1].dataType, e1[1].dims), I = T.type.value, z = null, O = [
                T,
                E
            ];
            e1.length === 3 && (z = P("c", e1[2].dataType, e1[2].dims.length), O.push(z));
            let D = M("output", e1[0].dataType, u.length);
            O.push(D);
            let L = [
                {
                    name: "output_size",
  ...
  ${$.mainStart()}
    ...
    output[global_idx] = value;
            ...
            let v = P("a", e1[0].dataType, e1[0].dims), x = P("b", e1[1].dataType, e1[1].dims), T = null, E = [
                v,
                x
            ];
            e1.length === 3 && (T = P("c", e1[2].dataType, e1[2].dims.length), E.push(T));
            let I = M("output", e1[0].dataType, u.length);
            E.push(I);
            let z = [
                {
                    name: "num_tile_n",
  ...
  ${$.mainStart([
    ...
    if (m < uniforms.M && n < uniforms.N) {
      output[m * uniforms.N + n] = value;
        ...
        Gf(e1.inputs), e1.compute(Hf(e1.inputs, t));
    };
});
var ut, yt, Ut, Nt, Ff, qf, jf, Kf, Zf, Qf, Yf, Xf, Bd, Dd, Md = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
...
`, Yf = (e1, t, r)=>(()=>{
        ...
        })() + `${e1.setByOffset("global_idx", "result")}`, Xf = (e1, t)=>{
        let r = P("x", e1[0].dataType, e1[0].dims.length), n = [
            e1[1].dims[0],
            e1[1].dims[1],
            e1[1].dims[2]
        ], o = P("grid", e1[1].dataType, n.length, 2), i = [
            e1[0].dims[0],
            e1[0].dims[1],
            e1[1].dims[1],
            e1[1].dims[2]
        ...
        let a = M("output", e1[0].dataType, i.length), u = r.type.value, d = k.size(i), c = [
            {
                type: 12,
                data: d
            },
  ...
  ${m.mainStart()}
    ${m.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${Yf(a, u, t)}
        ...
        Ff(e1.inputs), e1.compute(Xf(e1.inputs, t));
    }, Dd = (e1)=>J({
...
var Be, th, Ud, Rd, rh, er, Nd, $o = U(()=>{
    ...
    ie();
    st();
    Be = (e1, t)=>e1.length > t && e1[t].dims.length > 0 ? e1[t] : void 0, th = (e1, t)=>{
        let r = e1[0], n = Be(e1, 1), o = Be(e1, 2), i = Be(e1, 3), a = Be(e1, 4), u = Be(e1, 5), d = Be(e1, 6), c = Be(e1, 7);
        ...
        let u = [
            ...
            let f = M("qkv_with_bias", t.dataType, u), b = P("qkv", t.dataType, u), g = P("bias", r.dataType, u), _ = [
                {
                    name: "output_size",
                    type: "u32"
                },
  ...
  ${m.mainStart()}
    ...
    qkv_with_bias[global_idx] = qkv[global_idx] + bias[bias_offset_idx];
        ...
        if (a && k.size(a.dims) > 0) {
            ...
            return d = rh(e1, i, a, t, n, r * o, u), d = d.reshape([
                t,
                n,
                r,
                o
            ]), r === 1 || n === 1 ? d : e1.compute(Ee(d, Rd.perm), {
                inputs: [
                    d
                ],
                outputs: [
        ...
        let r = th(e1.inputs, t), n = e1.inputs[0], o = Be(e1.inputs, 1), i = Be(e1.inputs, 2), a = Be(e1.inputs, 3), u = Be(e1.inputs, 4), d = Be(e1.inputs, 5), c = Be(e1.inputs, 6), p = Be(e1.inputs, 7);
        ...
        let m = o && i && o.dims.length === 4 && i.dims.length === 4, f = er(e1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, n, a, 0);
        if (m) return Rt(e1, f, o, i, u, void 0, c, p, d, r);
        if (!o || !i) throw new Error("key and value must be provided");
        let b = er(e1, r.batchSize, r.numHeads, r.kvSequenceLength, r.headSize, o, a, r.hiddenSize), g = er(e1, r.batchSize, r.numHeads, r.kvSequenceLength, r.vHeadSize, i, a, 2 * r.hiddenSize);
        Rt(e1, f, b, g, u, void 0, c, p, d, r);
    };
});
var nh, oh, ih, ah, xo, Vd, Wd, So = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    nh = (e1)=>{
        ...
        return e1[1].dims[0] > 0 && (e1[1].getBigInt64Array().forEach((o)=>r.push(Number(o))), n = r.length), J({
            numOutputs: n,
            axis: t.axis,
            splitSizes: r
        });
...
`)}
        ...
        let r = e1[0].dims, n = k.size(r), o = e1[0].dataType, i = k.normalizeAxis(t.axis, r.length), a = new Array(t.numOutputs), u = P("input", o, r.length), d = new Array(t.numOutputs), c = [], p = [], m = 0, f = [
            {
                type: 12,
                data: n
            }
        ...
        for(let g = 0; g < t.numOutputs; g++){
            ...
            let _ = r.slice();
            _[i] = t.splitSizes[g], p.push(_), a[g] = M(`output${g}`, o, _.length), c.push({
                dims: p[g],
                dataType: e1[0].dataType
            });
        }
  ...
  ${g.mainStart()}
    ...
    writeBufferData(output_number, indices, global_idx);
        ...
        nh(e1.inputs);
        let r = e1.inputs.length === 1 ? t : oh(e1.inputs, t);
        e1.compute(xo(e1.inputs, r), {
            inputs: [
                0
            ]
        });
...
var sh, tn, Ld, To = U(()=>{
    ...
    ie();
    sh = (e1, t)=>{
        let [r, n, o, i] = e1, { numHeads: a, rotaryEmbeddingDim: u } = t;
        ...
        let { interleaved: r, numHeads: n, rotaryEmbeddingDim: o, scale: i } = t, a = e1[0].dims[0], u = k.sizeFromDimension(e1[0].dims, 1), d = e1[0].dims[e1[0].dims.length - 2], c = u / d, p = e1[2].dims[1], m = o === 0 ? p * 2 : c / n, f = new Array(a, d, c / m, m - p), b = k.computeStrides(f), g = [
            {
                type: 1,
                data: i
            },
            ...
            let $ = P("input", e1[0].dataType, e1[0].dims.length), v = P("position_ids", e1[1].dataType, e1[1].dims.length), x = P("cos_cache", e1[2].dataType, e1[2].dims.length), T = P("sin_cache", e1[3].dataType, e1[3].dims.length), E = M("output", e1[0].dataType, e1[0].dims.length);
        ...
        return {
            ...
            getRunData: ()=>({
                    ...
                    dispatchGroup: {
                        x: Math.ceil(k.size(f) / It)
                    },
                    programUniforms: g
                })
        };
    }, Ld = (e1, t)=>{
        sh(e1.inputs, t), e1.compute(tn(e1.inputs, t));
    };
});
var uh, dh, Gd, lh, Hd, Fd = U(()=>{
    "use strict";
    Se();
    ee();
    Fr();
    ...
    uh = (e1, t)=>{
        ...
        if (r.dims.length !== 3 && r.dims.length !== 5) throw new Error("Input query is expected to have 3 or 5 dimensions");
        let u = !1, d = r.dims[0], c = r.dims[1], p = r.dims.length === 3 ? ("TURBOPACK compile-time falsy", 0) ? ("TURBOPACK unreachable", undefined) : r.dims[2] : t.numHeads * r.dims[4], m = c, f = 0, b = !n || n.dims.length === 0, g = Math.floor(b ? p / (t.numHeads + 2 * t.kvNumHeads) : p / t.numHeads);
        b && (p = g * t.numHeads);
        ...
        let x = 0, T = !1, E = t.kvNumHeads ? g * t.kvNumHeads : p;
        ...
        return {
            ...
            vHiddenSize: E,
            headSize: g,
            vHeadSize: Math.floor(E / t.kvNumHeads),
            numHeads: t.numHeads,
        ...
        let o = 7, i = [
            ...
            let m = P("seq_lens", r.dataType, r.dims), f = P("total_seq_lens", n.dataType, n.dims), b = M("pos_ids", o, a), g = [
                {
                    name: "output_size",
                    type: "u32"
                },
  ...
  `;
        ...
        let n = e1.inputs[0], o = e1.inputs[1] && e1.inputs[1].dims.length > 0 ? e1.inputs[1] : void 0, i = e1.inputs[2] && e1.inputs[2].dims.length > 0 ? e1.inputs[2] : void 0, a = e1.inputs[3] && e1.inputs[3].dims.length !== 0 ? e1.inputs[3] : void 0, u = e1.inputs[4] && e1.inputs[4].dims.length !== 0 ? e1.inputs[4] : void 0, d = e1.inputs.length > 4 ? e1.inputs[5] : void 0, c = e1.inputs.length > 5 ? e1.inputs[6] : void 0, p = r.kvNumHeads ? r.kvNumHeads : r.numHeads, m = J({
            axis: 2,
            numOutputs: 3,
            splitSizes: [
        ...
        if (t.doRotary) {
            let T = e1.compute(lh(r.batchSize, r.sequenceLength, d, c), {
                inputs: [
                    d,
                    c
                ],
            ...
            })[0], E = e1.inputs[7], I = e1.inputs[8], z = J({
        ...
        let $ = er(e1, r.batchSize, r.numHeads, r.sequenceLength, r.headSize, t.doRotary ? _ : f, void 0, 0), v = Gd(e1, t.doRotary ? S : b, r), x = Gd(e1, g, r);
        Rt(e1, $, v, x, void 0, void 0, a, u, void 0, r, d, c);
    };
});
var qd, ch, ph, jd, Kd = U(()=>{
    "use strict";
    ee();
    ne();
    st();
    ...
    qd = (e1, t, r, n, o, i, a, u)=>{
        ...
        S.push(...N(b, g));
        let $ = (v)=>{
            let x = P("x", t.dataType, 3, d), T = P("scale", r.dataType, r.dims), E = P("bias", n.dataType, n.dims), I = M("output", 1, 3, 2), z = [
                x,
                T,
                E,
                I
  ...
  ${v.mainStart(f)}
    ...
    if (local_idx == 0) {
      ...
      output[workgroup_index] = vec2f(channel_scale, channel_shift);
        ...
        let n = t[0].dims, o = n, i = 2, a = n[0], u = n[1], d = k.sizeFromDimension(n, i), c = ce(d), p = k.size(o) / c, m = qd(e1, t[0], t[1], t[2], a, d, u, r.epsilon), f = [
            a,
            u,
            d / c
        ], b = [
            ...
            let $ = P("x", t[0].dataType, f.length, c), v = P("scale_shift", 1, b.length, 2), x = M("output", t[0].dataType, f.length, c), T = [
                $,
                v,
                x
            ];
  ...
  ${S.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.output_size")}
      ...
      ${x.setByOffset("global_idx", "value")};
        ...
        let n = t[0].dims, o = n, i = n[0], a = n[n.length - 1], u = k.sizeFromDimension(n, 1) / a, d = ce(a), c = k.size(o) / d, p = [
            {
                type: 12,
                data: u
            },
        ...
        f = f && n[n.length - 1] !== 1;
        let g = f ? e1.compute(Ee(e1.inputs[0], b), {
            inputs: [
                e1.inputs[0]
            ],
            outputs: [
            ...
            length: n.length
        }, ($, v)=>n[b[v]])), _ = qd(e1, g, t[1], t[2], i, u, a, r.epsilon), S = ($)=>{
  ...
  ${$.mainStart()}
    ...
    output[global_idx] = fma(input[global_idx], ${T(0)}, ${T(1)});
        ...
        t.format === "NHWC" ? ph(e1, e1.inputs, t) : ch(e1, e1.inputs, t);
    };
});
var mh, fh, Zd, Qd = U(()=>{
    "use strict";
    ...
    mh = (e1)=>{
        ...
        let n = t.simplified, o = e1[0].dims, i = e1[1], a = !n && e1[2], u = o, d = k.normalizeAxis(t.axis, o.length), c = k.sizeToDimension(o, d), p = k.sizeFromDimension(o, d), m = k.size(i.dims), f = a ? k.size(a.dims) : 0;
       ...
       Got scale size of ${m} and bias size of ${f}`);
        ...
        a && _.push("type");
        let $ = r > 1, v = r > 2, x = (E)=>{
            let I = be(e1[0].dataType), z = [
                P("x", e1[0].dataType, e1[0].dims, g),
                P("scale", i.dataType, i.dims, g)
            ];
            a && z.push(P("bias", a.dataType, a.dims, g)), z.push(M("output", e1[0].dataType, u, g)), $ && z.push(M("mean_data_output", 1, b)), v && z.push(M("inv_std_output", 1, b));
            let O = [
                {
                    name: "norm_count",
                    type: "u32"
  ...
  ${E.mainStart()}
    ...
    ${v ? "inv_std_output[global_idx] = inv_std_dev" : ""};
        ...
        mh(e1.inputs), e1.compute(fh(e1.inputs, t, e1.outputCount));
    };
});
var hh, Yd, Xd = U(()=>{
    "use strict";
    ...
    hh = (e1)=>{
        ...
        hh(e1.inputs);
        let t = Je.calcShape(e1.inputs[0].dims, e1.inputs[1].dims, !0);
        ...
        if (r < 8 && n < 8) e1.compute(Qr(e1.inputs, {
            activation: ""
        }, t));
        else {
            let o = t[t.length - 2], i = k.size(e1.inputs[0].dims.slice(0, -2)), a = k.size(e1.inputs[1].dims.slice(0, -2));
            if (i !== 1 && o === 1 && a === 1) {
            ...
            } else e1.compute(Jt(e1.inputs, {
                activation: ""
            }, t));
        }
    };
});
var gh, bh, yh, Jd, el, tl = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    gh = (e1, t)=>{
        ...
        if (e1.length === 4) {
            let p = e1[3].dims, m = t.bits > 4 ? t.n * o : t.n * Math.floor((o + 1) / 2);
            if (k.size(p) !== m) throw new Error("zeroPoints input size error.");
        }
    }, bh = (e1, t)=>{
        let r = e1[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, u = r.slice(0, n - 2), d = k.size(u), p = e1[1].dims[2] / 4, m = e1[0].dataType, f = ce(t.k), b = ce(p), g = ce(a), _ = u.concat([
            o,
            a
        ]), S = o > 1 && a / g % 2 === 0 ? 2 : 1, $ = k.size(_) / g / S, v = 64, x = [], T = [
            d,
            o,
            i / f
        ], E = k.convertShape(e1[1].dims).slice();
        E.splice(-1, 1, p / b), x.push(...N(T)), x.push(...N(E)), x.push(...N(e1[2].dims)), e1.length === 4 && x.push(...N(k.convertShape(e1[3].dims)));
        let I = [
            d,
            o,
            a / g
        ...
        x.push(...N(I));
        let z = (O)=>{
            let D = T.length, L = P("a", e1[0].dataType, D, f), q = P("b", 12, E.length, b), Q = P("scales", e1[2].dataType, e1[2].dims.length), W = [
                L,
                q,
                Q
            ], Z = e1.length === 4 ? P("zero_points", 12, e1[3].dims.length) : void 0;
            Z && W.push(Z);
            let we = I.length, H = M("output", e1[0].dataType, we, g), j = be(e1[0].dataType), te = (()=>{
                switch(f){
                    case 1:
                        return `array<${j}, 8>`;
                    case 2:
          ...
          `;
            ...
            b_quantized_values = ${te}(${Array.from({
                    length: 4
                }, (C, V)=>`${j}(b_value_lower[${V}]), ${j}(b_value_upper[${V}])`).join(", ")});
            b_dequantized_values = ${f === 1 ? `${te}(${Array.from({
                    length: 8
                }, (C, V)=>`(b_quantized_values[${V}] - ${Z ? `zero_point${re}` : "zero_point"}) * scale${re}`).join(", ")});` : `(b_quantized_values - ${te}(${Array(8).fill(`${Z ? `zero_point${re}` : "zero_point"}`).join(",")})) * scale${re};`};
            workgroup_shared[local_id.x * ${S} + ${Math.floor(re / g)}]${g > 1 ? `[${re % g}]` : ""} += ${Array.from({
                    length: 8 / f
                }, (C, V)=>`${f === 1 ? `a_data[${V}] * b_dequantized_values[${V}]` : `dot(a_data[${V}], b_dequantized_values[${V}])`}`).join(" + ")};
          `;
                return ye;
            }, ue = ()=>{
                let ye = `
        ...
        return {
            name: "MatMulNBits",
            shaderCache: {
                hint: `${t.blockSize};${t.bits};${f};${b};${g};${S};${v}`,
        ...
        let r = e1[0].dims, n = r.length, o = r[n - 2], i = t.k, a = t.n, u = r.slice(0, n - 2), d = k.size(u), p = e1[1].dims[2] / 4, m = e1[0].dataType, f = ce(t.k), b = ce(p), g = u.concat([
            o,
            a
        ]), _ = 128, S = a % 8 === 0 ? 8 : a % 4 === 0 ? 4 : 1, $ = _ / S, v = $ * b * 8, x = v / f, T = v / t.blockSize, E = k.size(g) / S, I = [], z = [
            d,
            o,
            i / f
        ], O = k.convertShape(e1[1].dims).slice();
        O.splice(-1, 1, p / b), I.push(...N(z)), I.push(...N(O)), I.push(...N(e1[2].dims)), e1.length === 4 && I.push(...N(k.convertShape(e1[3].dims)));
        let D = [
            d,
            o,
            a
        ...
        I.push(...N(D));
        let L = (q)=>{
            let Q = z.length, W = P("a", e1[0].dataType, Q, f), Z = P("b", 12, O.length, b), we = P("scales", e1[2].dataType, e1[2].dims.length), H = [
                W,
                Z,
                we
            ], j = e1.length === 4 ? P("zero_points", 12, e1[3].dims.length) : void 0;
            j && H.push(j);
            let te = D.length, X = M("output", e1[0].dataType, te), ue = be(e1[0].dataType), he = ()=>{
                switch(f){
                    case 1:
                        return `
        ...
        ${q.mainStart([
          ...
          for (var tile: u32 = 0; tile < num_tiles; tile += 1) {
            ...
            for (var i: u32 = 0; i < ${b}; i++) {
              ...
              let b_quantized_values = mat2x4<${ue}>(${Array.from({
                length: 4
            }, (ye, re)=>`${ue}(b_value_lower[${re}]), ${ue}(b_value_upper[${re}])`).join(", ")});
              ...
              inter_results[local_id.y][local_id.x] += ${Array.from({
                length: 2
            }, (ye, re)=>`${`dot(a_data${re}, b_dequantized_values[${re}])`}`).join(" + ")};
              word_offset += ${8 / f};
            }
            workgroupBarrier();
          }
        ...
        gh(e1.inputs, t), t.blockSize === 32 && e1.adapterInfo.isVendor("intel") && e1.adapterInfo.isArchitecture("gen-12lp") ? e1.compute(yh(e1.inputs, t)) : e1.compute(bh(e1.inputs, t));
    }, el = (e1)=>J(e1);
});
var _h, wh, vh, $h, xh, Sh, Th, Ih, rl, nl = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    _h = (e1)=>{
      ...
      `;
        ...
        switch(r.mode){
            case 0:
                return wh(e1, t, r.pads.length);
            case 1:
                return vh(e1, t, r.pads.length);
            case 2:
                return $h(e1, t, r.pads.length);
            case 3:
                return xh(e1, t, r.pads.length);
            default:
        ...
        let u = [
            ...
            let p = M("output", e1[0].dataType, r.length), m = P("x", e1[0].dataType, n.length), f = m.type.value, b = Sh(p, n.length, t), g = [
                {
                    name: "output_size",
                    type: "u32"
                },
        ...
        _h(e1.inputs);
        let r = Ih(e1.inputs, t);
        e1.compute(Th(e1.inputs, r), {
            inputs: [
                0
            ]
        });
...
var rn, ol, il, al, sl, Ch, Ah, ul, dl, ll, cl, pl, ml, fl, hl, gl, bl, yl, _l, wl = U(()=>{
    "use strict";
    We();
    ee();
    ne();
    ie();
    rn = (e1)=>{
        if (ge.webgpu.validateInputContent && (!e1 || e1.length !== 1)) throw new Error("Pool ops requires 1 input.");
    }, ol = (e1, t, r)=>{
    ...
    }, sl = (e1)=>`${e1.format};${e1.ceilMode};${e1.autoPad};${e1.kernelShape.length}`, Ch = (e1)=>`${sl(e1)};${e1.countIncludePad}`, Ah = (e1)=>`${sl(e1)};${e1.storageOrder};${e1.dilations}`, ul = (e1)=>({
            format: e1.format,
            autoPad: [
                "NOTSET",
                "VALID",
        ...
        return {
            ...
            getShaderSource: (S)=>al(S, a, t.dims.length, i.length, o, d, c, 0, m, f, b, g)
        };
    }, ll = (e1)=>{
        let t = e1.count_include_pad !== 0, r = ul(e1);
        ...
        rn(e1.inputs), e1.compute(dl("AveragePool", e1.inputs[0], !1, t));
    }, pl = {
        autoPad: "",
        ceilMode: 0,
        countIncludePad: !1,
        ...
        rn(e1.inputs), e1.compute(dl("GlobalAveragePool", e1.inputs[0], !0, t));
    }, hl = (e1, t, r, n)=>{
        let [o, i] = ol(t, n, r), a = `
    ...
    `, u = "", d = P("x", t.dataType, t.dims.length), c = [
        ...
        return p.push(...N(t.dims, i)), {
            ...
            getShaderSource: (_)=>al(_, d, t.dims.length, i.length, o, a, u, t.dataType === 10 ? -65504 : -1e5, m, f, b, g)
        };
    }, gl = (e1, t)=>{
        rn(e1.inputs), e1.compute(hl("MaxPool", e1.inputs[0], !1, t));
    }, bl = (e1)=>{
        let t = e1.storage_order, r = e1.dilations, n = ul(e1);
        ...
        rn(e1.inputs), e1.compute(hl("GlobalMaxPool", e1.inputs[0], !0, t));
    };
});
var kh, Ph, vl, $l, xl = U(()=>{
    "use strict";
    ...
    kh = (e1, t)=>{
        ...
        let r = k.normalizeAxis(t.axis, e1[0].dims.length), n = e1[0].dataType, o = n === 3, i = e1[0].dims, a = e1[1].dataType, u = k.size(i), d = n === 3 || n === 2, c = d ? [
            Math.ceil(k.size(e1[0].dims) / 4)
        ] : e1[0].dims, p = e1[1].dims, m = e1.length > 2 ? e1[2] : void 0, f = m ? d ? [
            Math.ceil(k.size(m.dims) / 4)
        ] : m.dims : void 0, b = p.length === 0 || p.length === 1 && p[0] === 1, g = b === !1 && p.length === 1, _ = ce(u), S = b && (!d || _ === 4), $ = S ? _ : 1, v = S && !d ? _ : 1, x = P("input", d ? 12 : n, c.length, v), T = P("scale", a, p.length), E = m ? P("zero_point", d ? 12 : n, f.length) : void 0, I = M("output", a, i.length, $), z = [
            x,
            T
        ];
        E && z.push(E);
      ...
      ${I.setByOffset("global_idx", `${I.type.value}(x_value - zero_point_value) * scale_value`)};
        ...
        kh(e1.inputs, t), e1.compute(Ph(e1.inputs, t));
    }, $l = (e1)=>J({
            axis: e1.axis,
            blockSize: e1.blockSize
        });
...
var zh, Oh, Sl, Tl = U(()=>{
    ...
    zh = (e1, t, r)=>{
        ...
        let o = Math.abs(Math.ceil((t - e1) / r)), i = [
            ...
            let p = M("output", n, i.length), m = p.type.value, f = [
                {
                    name: "outputSize",
                    type: "u32"
                },
        ...
        let t = 0, r = 0, n = 0;
        e1.inputs[0].dataType === 6 ? (t = e1.inputs[0].getInt32Array()[0], r = e1.inputs[1].getInt32Array()[0], n = e1.inputs[2].getInt32Array()[0]) : e1.inputs[0].dataType === 1 && (t = e1.inputs[0].getFloat32Array()[0], r = e1.inputs[1].getFloat32Array()[0], n = e1.inputs[2].getFloat32Array()[0]), ge.webgpu.validateInputContent && zh(t, r, n), e1.compute(Oh(t, r, n, e1.inputs[0].dataType), {
            inputs: []
        });
    };
});
var Bh, Il, Cl, Dh, Al, El, kl = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    data_offset += u32((u32(index) * element_count_dim));`, Cl = (e1, t, r)=>`for (var i = 0u; i < uniforms.num_updates_elements; i++) {
        let value = updates[uniforms.num_updates_elements * ${r ? "global_idx" : "idx"} + i];
        ${Bh(e1.reduction, "output[data_offset + i]", "value", t)}
      }`, Dh = (e1, t)=>{
        let r = e1[0].dims, n = e1[1].dims, o = r, i = 1, a = Math.ceil(k.size(n) / i), u = n[n.length - 1], d = k.sizeFromDimension(r, u), c = k.sizeFromDimension(n, 0) / u, p = [
            {
                type: 12,
                data: a
            },
            ...
            let b = P("indices", e1[1].dataType, e1[1].dims.length), g = P("updates", e1[2].dataType, e1[2].dims.length, i), _ = t.reduction !== "none" && t.reduction !== "" ? es("output", e1[0].dataType, o.length) : M("output", e1[0].dataType, o.length, i);
            return `
...
var Mh, Rh, Uh, Pl, Nh, Vh, Wh, Lh, Gh, Hh, Fh, qh, zl, jh, Kh, Zh, Qh, Yh, Ol, Bl, Dl = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    Mh = (e1, t)=>{
        ...
        if (a > 0 && e1.length > a && e1[a].dims.length > 0) e1[a].getFloat32Array().forEach((p)=>i.push(p));
        ...
        if (u > 0 && e1.length > u && e1[u].dims.length === 1 && e1[u].dims[0] > 0) {
            if (e1[u].getFloat32Array().forEach((p)=>n.push(p)), n.length !== 0 && n.length !== c && r >= 18 && n.length !== t.axes.length) throw new Error("Resize requires scales input size to be same as input rank or axes size for opset 18 and up");
            Mh(n, t), t.axes.length > 0 && Rh(n, t.axes, c).forEach((p, m)=>n[m] = p);
        }
        if (d > 0 && e1.length > d && e1[d].dims.length === 1 && e1[d].dims[0] > 0 && (e1[d].getBigInt64Array().forEach((p)=>o.push(Number(p))), o.length !== 0 && o.length !== c && r >= 18 && o.length !== t.axes.length)) throw new Error("Resize requires sizes input size to be same as input rank or axes size for opset 18 and up");
        if (t.axes.length > 0) {
  ...
  return whole + fract;
`, Nh = (e1, t)=>`fn getOriginalCoordinateFromResizedCoordinate(xResized: u32, xScale: f32, lengthResized: u32,
     lengthOriginal: u32, roiStart: f32, roiEnd: f32) -> ${t} { ` + (()=>{
        ...
        })() + "}", Vh = (e1, t, r)=>`fn getNearestPixelFromOriginal(xOriginal: ${r}, isDownSample: bool) -> ${r} {` + (()=>{
            switch(e1){
...
` : "", jh = (e1, t, r, n, o)=>{
    ...
    fn getInputValue(batch: u32, channel: u32, row: u32, col: u32) -> ${p} {
      var input_indices: ${e1.type.indices};
      ${e1.indicesSet("input_indices", u, `max(0, min(row, ${r[u]} - 1))`)};
    ...
    }, Kh = (e1, t, r, n, o, i, a, u, d, c)=>{
        let p = r.length === 2, m = !0, [f, b] = p ? [
            0,
            1
        ] : ("TURBOPACK compile-time truthy", 1) ? [
            2,
            3
        ] : ("TURBOPACK unreachable", undefined), g = e1.type.value, _ = (S)=>{
            let $ = S === f ? "row" : "col";
            return `
      fn ${$}CubicInterpolation(input_indices: ${e1.type.indices}, output_indices: ${t.type.indices}) -> ${g} {
        ...
        var input_indices_copy: ${e1.type.indices} = input_indices;
          ${e1.indicesSet("input_indices_copy", S, `u32(${$})`)};
          data[i + 1] = ${S === f ? e1.getByIndices("input_indices_copy") : "rowCubicInterpolation(input_indices_copy, output_indices)"};
        }
  ...
  fn bicubicInterpolation(output_indices: ${t.type.indices}) -> ${g} {
    ...
    fn getInputValue(batch: u32, channel: u32, depth:u32, height: u32, width: u32) -> ${m} {
      var input_indices: ${e1.type.indices};
      ${e1.indicesSet("input_indices", u, `max(0, min(depth, ${r[u]} - 1))`)};
      ${e1.indicesSet("input_indices", d, `max(0, min(height, ${r[d]} - 1))`)};
      ${e1.indicesSet("input_indices", c, `max(0, min(width, ${r[c]} - 1))`)};
      ${zl(e1, p, a, 3)}
      return ${e1.getByIndices("input_indices")};
    }
    ...
    depth = max(0, min(depth, ${r[u]} - 1));
      ...
      return (x111 * dx2 * dy2 * dz2 + x112 * dx2 * dy2 * dz1 + x121 * dx2 * dy1 *dz2 + x122 * dx2 * dy1 * dz1 +
        ...
        let a = e1.dims, u = Wh(i, t.axes, a.length), d = Lh(a, n, o, t.axes), c = n.slice();
        n.length === 0 && (c = a.map((v, x)=>v === 0 ? 1 : d[x] / v), t.keepAspectRatioPolicy !== "stretch" && (d = Gh(a, c, t)));
        let p = M("output", e1.dataType, d.length), m = P("input", e1.dataType, a.length), f = k.size(d), b = a.length === d.length && a.every((v, x)=>v === d[x]), g = t.coordinateTransformMode === "tf_crop_and_resize", _ = t.extrapolationValue, S = m.type.value, $ = (v)=>`
      ${b ? "" : `
...
`}
        ...
        return {
            name: "Resize",
            shaderCache: {
                hint: `${t.cacheKey}|${r}|${c.length > 0 ? t.mode === "cubic" ? c : c.length : ""}|${o.length > 0 ? o : ""}|${u.length > 0 ? u : ""}|${b}|${t.mode === "nearest" ? a.length : a}`,
                inputDependencies: [
                    "rank"
                ]
            },
        ...
        Uh(e1.inputs, t, i, r, n, o), e1.compute(Qh(e1.inputs[0], t, i, r, n, o), {
            inputs: [
                0
            ]
        });
    }, Bl = (e1)=>{
        let t = e1.antialias, r = e1.axes, n = e1.coordinateTransformMode, o = e1.cubicCoeffA, i = e1.excludeOutside !== 0, a = e1.extrapolationValue, u = e1.keepAspectRatioPolicy, d = e1.mode, c = e1.nearestMode === "" ? "simple" : e1.nearestMode;
        return J({
            antialias: t,
            axes: r,
...
var Xh, Jh, Ml, Rl = U(()=>{
    ...
    Xh = (e1)=>{
        ...
        let o = t.simplified, i = e1[0].dims, a = k.size(i), u = i, d = a, c = i.slice(-1)[0], p = n ? i.slice(0, -1).concat(1) : [], m = !o && e1.length > 3, f = e1.length > 4, b = n && r > 1, g = n && r > 2, _ = r > 3, S = 64, $ = ce(c), v = [
            {
                type: 12,
                data: d
            },
            ...
            let I = [
                ...
                P("x", e1[0].dataType, e1[0].dims, $),
                P("skip", e1[1].dataType, e1[1].dims, $),
                P("gamma", e1[2].dataType, e1[2].dims, $)
            ];
            m && z.push(P("beta", e1[3].dataType, e1[3].dims, $)), f && z.push(P("bias", e1[4].dataType, e1[4].dims, $)), z.push(M("output", e1[0].dataType, u, $)), b && z.push(M("mean_output", 1, p)), g && z.push(M("inv_std_output", 1, p)), _ && z.push(M("input_skip_bias_sum", e1[0].dataType, u, $));
            let O = be(e1[0].dataType), D = be(1, $);
            return `
      ...
      ${E.mainStart([
        ...
        return r > 1 && T.push({
            ...
            shaderCache: {
                hint: `${$};${b};${g};${_}`,
                inputDependencies: e1.map((E, I)=>"type")
            },
            getShaderSource: x,
            getRunData: ()=>({
                    outputs: T,
        ...
        e1.outputCount > 1 && n.push(-3), e1.outputCount > 2 && n.push(-3), e1.outputCount > 3 && n.push(3), e1.compute(Jh(e1.inputs, t, e1.outputCount, !1), {
            outputs: n
        });
    };
});
var eg, nn, tg, Ul, rg, ng, Nl, Vl, Wl = U(()=>{
    "use strict";
    ee();
    ne();
    Se();
    ...
    eg = (e1, t)=>{
        ...
        if (e1.length > 1) {
            let r = nn(e1, 1), n = nn(e1, 2), o = nn(e1, 3);
            return o.length === 0 && (o = [
    ...
    }, rg = (e1, t, r)=>`fn calculateInputIndices(output_indices: ${t.type.indices}) -> ${e1.type.indices} {
          var input_indices: ${e1.type.indices};
          var carry = 0u;
        ...
        let p = {
            dims: c,
            dataType: e1[0].dataType
        }, m = M("output", e1[0].dataType, c.length), f = P("input", e1[0].dataType, e1[0].dims.length), b = k.size(c), g = [
            {
                name: "outputSize",
                type: "u32"
            },
      ...
      ${$.registerUniforms(g).declareVariables(f, m)}
        ...
        eg(e1.inputs, t);
        let r = tg(e1.inputs, t);
        e1.compute(ng(e1.inputs, r), {
            inputs: [
                0
            ]
        });
...
var og, ig, Ll, Gl, Hl = U(()=>{
    ...
    og = (e1)=>{
        ...
        let r = e1.inputs[0], n = r.dims, o = k.size(n), i = n.length, a = k.normalizeAxis(t.axis, i), u = a < n.length - 1, d, c = [];
        u ? (c = Array.from({
            length: i
        }, (z, O)=>O), c[a] = i - 1, c[i - 1] = a, d = e1.compute(Ee(r, c), {
            inputs: [
                r
            ],
            outputs: [
      ...
      ${z.mainStart(_)}
        ...
        og(e1.inputs), ig(e1, t);
    }, Gl = (e1)=>J({
            axis: e1.axis
        });
});
var Fl, ag, sg, ug, ql, jl = U(()=>{
    "use strict";
    ee();
    ne();
    ie();
    Fl = (e1)=>Array.from(e1.getBigInt64Array(), Number), ag = (e1)=>{
        ...
        let r = e1[0].dims, n = t ?? Fl(e1[1]), o = sg(r, n), i = k.size(o), a = e1[0].dataType, u = P("input", a, r.length), d = M("output", a, o.length), c = (p)=>`
      ...
      ${d.setByOffset("global_idx", u.getByIndices("input_indices"))}
        ...
        ag(e1.inputs), e1.compute(ug(e1.inputs), {
            inputs: [
                0
            ]
        });
...
var dg, lg, Kl, Zl = U(()=>{
    ...
    dg = (e1, t, r, n, o)=>{
        ...
        return `
        ${e1.registerUniform("vec_size", "u32").declareVariables(d, a, u, i)}
        ${e1.mainStart()}
        ${e1.guardAgainstOutOfBoundsWorkgroupSizes("uniforms.vec_size")}
        ${c}
      }`;
    }, lg = (e1)=>{
        let t = e1[1].dims, r = e1[2].dims, n = e1[0].dims, o = e1[1].dataType, i = !(k.areEqual(t, r) && k.areEqual(r, n)), a = t, u = k.size(t);
        if (i) {
            let c = Je.calcShape(Je.calcShape(t, r, !1), n, !1);
        ...
        return {
            ...
            getShaderSource: (c)=>dg(c, e1, a, i, o),
            getRunData: ()=>({
                    outputs: [
                        {
                            dims: a,
...
var cg, pg, Io, Co, ec = U(()=>{
    ...
    cg = (e1, t)=>{
        ...
        let n = e1.name;
        return e1.shaderCache?.hint && (n += "[" + e1.shaderCache.hint + "]"), n += ":" + r + `:${cg(t, e1.shaderCache?.inputDependencies ?? new Array(t.length).fill("dims"))}`, n;
    }, Io = class {
        constructor(t){
        ...
        async initialize(t, r) {
            ...
            i("chromium-experimental-timestamp-query-inside-passes") || i("timestamp-query"), i("shader-f16"), i("subgroups"), this.device = await r.requestDevice(o), this.adapterInfo = new Io(r.info || await r.requestAdapterInfo()), this.gpuDataManager = Xa(this), this.programManager = new on(this), this.kernels = new Map, this.kernelPersistentData = new Map, this.kernelCustomData = new Map, Br(t.logLevel, !!t.debug), this.device.onuncapturederror = (a)=>{
            ...
            this.queryType !== "none" && (this.commandEncoder.resolveQuerySet(this.querySet, 0, this.pendingDispatchNumber * 2, this.queryResolveBuffer, 0), t = this.device.createBuffer({
                ...
                for(let o = 0; o < r.length / 2; o++){
                    ...
                    if (this.env.webgpu.profiling?.ondata) this.env.webgpu.profiling.ondata({
                        version: 1,
                        inputsMetadata: m.map(($)=>({
                                dims: $.dims,
                                dataType: Ye($.dataType)
                            })),
                        outputsMetadata: f.map(($)=>({
                                dims: $.dims,
                                dataType: Ye($.dataType)
                            })),
                        kernelId: a,
        ...
        run(t, r, n, o, i, a) {
            ...
            if (p) {
                ...
                p.forEach((O, D)=>{
                    let L = T[D], q = typeof O.data == "number" ? [
                        O.data
                    ] : O.data;
                ...
                this.device.queue.writeBuffer(z.buffer, 0, I, 0, x), this.gpuDataManager.release(z.id), g = {
                    offset: 0,
                    size: x,
                    buffer: z.buffer
                };
...
var tr, Ao, mg, rc = U(()=>{
    ...
    tr = class e1 {
        ...
        if (e1 === "webgpu") {
            ...
            await a.initialize(r, n), o("webgpu", [
                a,
                (u)=>a.alloc(Number(u)),
                (u)=>a.free(u),
                (u, d, c, p = !1)=>{
                ...
                (u, d, c)=>a.createKernel(u, Number(d), c, t.UTF8ToString(t._JsepGetNodeName(Number(d)))),
                (u)=>a.releaseKernel(u),
                (u, d, c, p)=>{
            ...
            o("webnn", [
                ...
                async (a, u, d, c, p)=>i.ensureTensor(a, u, d, c, p),
                (a, u)=>{
                    i.uploadTensor(a, u);
                },
...
var fg, vr, $r, At, hg, nc, jt, xr, Sr, oc, Tr, Ir, Cr, Vn = U(()=>{
    "use strict";
    Ma();
    Ua();
    ee();
    ...
    jn();
    fg = (e1, t)=>{
        fe()._OrtInit(e1, t) !== 0 && pe("Can't initialize onnxruntime.");
    }, vr = async (e1)=>{
        ...
        try {
            ...
            r._OrtGetInputOutputMetadata(e1, t, a, a + i) !== 0 && pe("Can't get session input/output metadata.");
        ...
        let t = fe(), r = t._malloc(e1.byteLength);
        ...
        try {
            ...
            for (let T of t?.executionProviders ?? [])if ((typeof T == "string" ? T : T.name) === "webnn") {
                if (o.shouldTransferToMLTensor = !1, typeof T != "string") {
                    let I = T, z = I?.context, O = I?.gpuDevice, D = I?.deviceType, L = I?.powerPreference;
                    z ? o.currentContext = z : O ? o.currentContext = await o.webnnCreateMLContext(O) : o.currentContext = await o.webnnCreateMLContext({
                        deviceType: D,
                        powerPreference: L
                    });
            ...
            i = await o._OrtCreateSession(r, n, a), o.webgpuOnCreateSession?.(i), i === 0 && pe("Can't create a session."), o.jsepOnCreateSession?.(), o.currentContext && (o.webnnRegisterMLContext(i, o.currentContext), o.currentContext = void 0, o.shouldTransferToMLTensor = !0);
            ...
            let x = null;
            return v.some((T)=>T === "gpu-buffer" || T === "ml-tensor") && (u = o._OrtCreateBinding(i), u === 0 && pe("Can't create IO binding."), x = {
                handle: u,
                outputPreferredLocations: v,
                outputPreferredLocationsEncoded: v.map((T)=>qn(T))
            }), At.set(i, [
                i,
                c,
                p,
        ...
        let t = fe(), r = At.get(e1);
        if (!r) throw new Error(`cannot release session. invalid session id: ${e1}`);
        let [n, o, i, a, u] = r;
        a && (u && t._OrtClearBoundOutputs(a.handle) !== 0 && pe("Can't clear bound outputs."), t._OrtReleaseBinding(a.handle) !== 0 && pe("Can't release IO binding.")), t.jsepOnReleaseSession?.(e1), t.webnnOnReleaseSession?.(e1), t.webgpuOnReleaseSession?.(e1), o.forEach((d)=>t._OrtFree(d)), i.forEach((d)=>t._OrtFree(d)), t._OrtReleaseSession(n) !== 0 && pe("Can't release session."), At.delete(e1);
    }, oc = async (e1, t, r, n, o, i, a = !1)=>{
        if (!e1) {
            t.push(0);
            return;
        }
        let u = fe(), d = u.PTR_SIZE, c = e1[0], p = e1[1], m = e1[3], f = m, b, g;
    ...
    }, Tr = async (e1, t, r, n, o, i)=>{
        let a = fe(), u = a.PTR_SIZE, d = At.get(e1);
        ...
        try {
            [$, v] = Da(i);
            for(let W = 0; W < _; W++)await oc(r[W], x, E, e1, p[t[W]], t[W], b);
            for(let W = 0; W < S; W++)await oc(o[W], T, E, e1, m[n[W]], _ + n[W], b);
            ...
            if (f && !g) {
                ...
                for(let H = 0; H < _; H++){
                    let j = t[H];
                    await a._OrtBindInput(W, p[j], x[H]) !== 0 && pe(`Can't bind input[${H}] for session=${e1}.`);
                }
                for(let H = 0; H < S; H++){
                    let j = n[H];
                    o[H]?.[3] ? a._OrtBindOutput(W, m[j], T[H], 0) !== 0 && pe(`Can't bind pre-allocated output[${H}] for session=${e1}.`) : a._OrtBindOutput(W, m[j], 0, we[j]) !== 0 && pe(`Can't bind output[${H}] to ${Z[H]} for session=${e1}.`);
                }
                At.set(e1, [
                    c,
                    p,
            ...
            for(let W = 0; W < S; W++){
                ...
                let we = a.stackSave(), H = a.stackAlloc(4 * u), j = !1, te, X = 0;
                try {
                    ...
                    if (te === "string") {
                        ...
                        j = !0, Q.push([
                            ...
                            {
                                gpuBuffer: $e,
                                download: a.jsepCreateDownloader($e, Ce, te),
                                dispose: ()=>{
                        ...
                        if (te === "int64" && !$e(e1)) throw new Error('preferredLocation "ml-tensor" for int64 output is not supported by current WebNN Context.');
                        let _t = await ve(e1, X, ye, V, !1);
                        j = !0, Q.push([
                            te,
                            V,
                            {
                                mlTensor: _t,
                                download: a.webnnCreateMLTensorDownloader(X, te),
                                dispose: ()=>{
                        ...
                        new Uint8Array($e.buffer, $e.byteOffset, $e.byteLength).set(a.HEAPU8.subarray(X, X + $e.byteLength)), Q.push([
                            te,
                            V,
                            $e,
                            "cpu"
            ...
            return f && !b && (a._OrtClearBoundOutputs(f.handle) !== 0 && pe("Can't clear bound outputs."), At.set(e1, [
                c,
                p,
                m,
                f,
...
var Et, Le, rr, sn, un, an, Eo, ko, Vt, Wt, bg, ic, ac, sc, uc, dc, lc, cc, Po = U(()=>{
    "use strict";
    We();
    Vn();
    ht();
    _r();
    Et = ()=>!!ge.wasm.proxy && typeof document < "u", rr = !1, sn = !1, un = !1, ko = new Map, Vt = (e1, t)=>{
        let r = ko.get(e1);
        r ? r.push(t) : ko.set(e1, [
            t
        ]);
    }, Wt = ()=>{
        ...
        switch(e1.data.type){
            case "init-wasm":
                rr = !1, e1.data.err ? (un = !0, Eo[1](e1.data.err)) : (sn = !0, Eo[0]()), an && (URL.revokeObjectURL(an), an = void 0);
                break;
            case "init-ep":
            case "copy-from":
            case "create":
        ...
        if (!sn) {
            ...
            if (rr = !0, Et()) return new Promise((e1, t)=>{
                Le?.terminate(), za().then(([r, n])=>{
                    try {
                        Le = n, Le.onerror = (i)=>t(i), Le.onmessage = bg, Eo = [
                            e1,
                            t
                        ];
                        let o = {
                        ...
                        !o.in.wasm.wasmPaths && (r || Gn) && (o.in.wasm.wasmPaths = {
            ...
            try {
                await wr(ge.wasm), await vr(ge), sn = !0;
            } catch (e1) {
                throw un = !0, e1;
            } finally{
                rr = !1;
        ...
        await $r(ge, e1);
    }, sc = async (e1)=>Et() ? (Wt(), new Promise((t, r)=>{
            Vt("copy-from", [
                t,
                r
            ]);
...
var fc, ln, _g, gc = U(()=>{
    ...
    fc = ()=>{
        ...
        let e1 = ge.wasm.simd;
        if (typeof e1 != "boolean" && e1 !== void 0 && e1 !== "fixed" && e1 !== "relaxed" && (console.warn(`Property "env.wasm.simd" is set to unknown value "${e1}". Reset it to \`false\` and ignore SIMD feature checking.`), ge.wasm.simd = !1), typeof ge.wasm.proxy != "boolean" && (ge.wasm.proxy = !1), typeof ge.wasm.trace != "boolean" && (ge.wasm.trace = !1), typeof ge.wasm.numThreads != "number" || !Number.isInteger(ge.wasm.numThreads) || ge.wasm.numThreads <= 0) if (typeof self < "u" && !self.crossOriginIsolated) ge.wasm.numThreads = 1;
        else {
...
We();
We();
var _a = "1.22.0-dev.20250409-89f8206ba4";
var IS = Nn;
{
    let e1 = (gc(), Ft(hc)).wasmBackend;
    $t("webgpu", e1, 5), $t("webnn", e1, 5), $t("cpu", e1, 10), $t("wasm", e1, 10);
...
//# sourceMappingURL=node_modules_onnxruntime-web_dist_7898de0d._.js.map