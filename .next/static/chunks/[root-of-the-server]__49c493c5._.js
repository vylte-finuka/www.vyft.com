...
"[project]/app/[lang]/components/config/walletconnect.ts [client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reown$2f$appkit$2d$universal$2d$connector$2f$dist$2f$esm$2f$src$2f$UniversalConnector$2e$js__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@reown/appkit-universal-connector/dist/esm/src/UniversalConnector.js [client] (ecmascript)");
;
...
async function getUniversalConnector() {
    const universalConnector = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$reown$2f$appkit$2d$universal$2d$connector$2f$dist$2f$esm$2f$src$2f$UniversalConnector$2e$js__$5b$client$5d$__$28$ecmascript$29$__["UniversalConnector"].init({
        projectId,
        metadata: {
            name: 'Vyft Slura',
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/[lang]/components/config/walletconnect.ts [client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function Vyftslide() {
    ...
    const [universalConnector, setUniversalConnector] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const [isAddingToken, setIsAddingToken] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Vyftslide.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["getUniversalConnector"])().then({
                "Vyftslide.useEffect": (connector)=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Vyftslide.useEffect": ()=>{
            if ("object" === 'undefined' || !window.ethereum) return;
            const tryAutoConnect = {
                "Vyftslide.useEffect.tryAutoConnect": async ()=>{
                    try {
            ...
            }["Vyftslide.useEffect.tryAutoConnect"];
            tryAutoConnect();
            const handleAccountsChanged = {
                "Vyftslide.useEffect.handleAccountsChanged": (accounts)=>setAccount(accounts[0] || null)
            }["Vyftslide.useEffect.handleAccountsChanged"];
            const handleChainChanged = {
                "Vyftslide.useEffect.handleChainChanged": ()=>{}
            }["Vyftslide.useEffect.handleChainChanged"];
        ...
        try {
            ...
            const watchParams = {
                ...
                options: {
                    ...
                    symbol: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["sluraCharene"].nativeCurrency.symbol,
                    decimals: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["sluraCharene"].nativeCurrency.decimals,
                    name: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["sluraCharene"].nativeCurrency.name,
                    image: __TURBOPACK__imported__module__$5b$project$5d2f$app$2f5b$lang$5d2f$components$2f$config$2f$walletconnect$2e$ts__$5b$client$5d$__$28$ecmascript$29$__["sluraCharene"].iconUrls?.[0] // Logo du réseau (ou fallback)
                     || '/Slura.png' // Fichier local public/
                }
            };
            // Flux injected (MetaMask, Rabby, etc.)
            if ("object" !== 'undefined' && window.ethereum && account) {
...
_s(Vyftslide, "5rfUqrn0MgEo8WTlC7KtWUExn44=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__49c493c5._.js.map