...
([__TURBOPACK__imported__module__$5b$externals$5d2f$stripe__$5b$external$5d$__$28$stripe$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
;
;
...
async function Vyfthealth_proc(req, res) {
    ...
    if (req.method === "GET") {
        try {
            ...
            try {
                const resp = await __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__["default"].get(`https://api.stripe.com/v1/invoices/upcoming?customer=${stripeCustomerId}`, {
                    headers: {
                        Authorization: `Bearer "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"`
                    }
                });
                if (resp.data && resp.data.amount_due !== undefined) {
                    upcomingInvoiceAmount = resp.data.amount_due / 100;
                }
            } catch (err) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__abc149fe._.js.map