...
function Home() {
    ...
    const [showBands, setShowBands] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    // Animation verticale au scroll rapide
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useEffect(()=>{
        let lastScrollY = window.scrollY;
        const handleScroll = ()=>{
            const currentScrollY = window.scrollY;
            if (currentScrollY > lastScrollY) {
                // Scroll vers le bas : on déploie les bandes
                setShowBands(true);
                controls.start((i)=>({
                        x: 120 + i * 60,
                        y: 120 + i * 60,
                ...
                // Scroll vers le haut : on regroupe tout sur l'original
                setShowBands(false);
                controls.start((i)=>({
                        x: 0,
                        y: 0,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__09827068._.js.map