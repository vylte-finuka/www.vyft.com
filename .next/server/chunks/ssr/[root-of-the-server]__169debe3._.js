...
var __TURBOPACK__imported__module__$5b$externals$5d2f40$huggingface$2f$transformers__$5b$external$5d$__$2840$huggingface$2f$transformers$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/@huggingface/transformers [external] (@huggingface/transformers, esm_import)"); // Import pour le modèle local
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
;
;
let generator = null; // Cache du pipeline pour éviter rechargement
// Fonction pour initialiser et utiliser le modèle local
async function initLocalAI() {
    if (!generator) {
        generator = await (0, __TURBOPACK__imported__module__$5b$externals$5d2f40$huggingface$2f$transformers__$5b$external$5d$__$2840$huggingface$2f$transformers$2c$__esm_import$29$__["pipeline"])("text-generation", "Xenova/phi-3-mini-4k-instruct-onnx-webgpu", {
            device: "webgpu"
        });
    }
    return generator;
}
// Fonction de génération locale (remplace callPublicAI)
async function callLocalAI(messages) {
    const ai = await initLocalAI();
    // Formate l'historique en prompt instruct (adapté à Phi-3)
    let prompt = "You are a helpful AI assistant for reports. Answer concisely.\n\n";
    messages.forEach((msg)=>{
        prompt += `${msg.from === "user" ? "User" : "AI"}: ${msg.text}\n`;
    });
    prompt += "AI: ";
    // Génère la réponse
    ...
    return output[0].generated_text.split("AI: ").pop()?.trim() || "Désolé, je n'ai pas compris.";
}
function SquareAIFloat() {
    ...
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([
        {
            from: "ai",
            text: "Bonjour, comment puis-je vous aider sur vos rapports ?"
        }
    ]);
    ...
    const [initialLoading, setInitialLoading] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])(true); // Pour le chargement du modèle
    ...
    // Charge le modèle au montage (une fois)
    (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useEffect"])(()=>{
        initLocalAI().then(()=>setInitialLoading(false)).catch((error)=>{
            ...
            setMessages((msgs)=>[
                    ...
                    {
                        from: "ai",
                        text: "Erreur : Modèle non chargé. Vérifiez votre navigateur."
                    }
                ]);
        });
    }, []);
    async function sendMessage() {
        if (!input.trim() || initialLoading) return;
        const newMessages = [
            ...messages,
            {
                from: "user",
        ...
        setLoading(true);
        setInput("");
        const reply = await callLocalAI(newMessages);
        setMessages([
            ...newMessages,
            {
                from: "ai",
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ...
        onClick: ()=>setOpen((v)=>!v),
        className: "jsx-7a70c89a7ea14636" + " " + (__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$page$2e$module$2e$css__$5b$ssr$5d$__$28$css__module$29$__["default"].bodyonwhite || ""),
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                style: {
                    display: "flex",
                ...
                className: "jsx-7a70c89a7ea14636",
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        style: {
                            width: 38,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("h3", {
                        ...
                        className: "jsx-7a70c89a7ea14636",
                        children: "Vyft program Érethense AI (Local)"
                    }, void 0, false, {
                        fileName: "[project]/app/components/SquareAIFloat.tsx",
                        lineNumber: 125,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                        ...
                        className: "jsx-7a70c89a7ea14636",
                        children: [
                            initialLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                className: "jsx-7a70c89a7ea14636",
                                children: "Chargement du modèle local... (une fois seulement)"
                            }, void 0, false, {
                                fileName: "[project]/app/components/SquareAIFloat.tsx",
                                lineNumber: 165,
                                columnNumber: 30
...
// Les composants Bubble, TypingBubble, TypingDots, Dot restent inchangés
function Bubble({ from, text }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        style: {
            alignSelf: from === "user" ? "flex-end" : "flex-start",
            background: from === "ai" ? "rgba(0,0,0,0.07)" : "#e0dbdd",
            color: "#222",
            borderRadius: 12,
            padding: "10px 16px",
            maxWidth: "80%",
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SquareAIFloat$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/SquareAIFloat.tsx [ssr] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__,
...
([__TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$Navbar$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$chartjs$2d$2__$5b$external$5d$__$28$react$2d$chartjs$2d$2$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$chart$2e$js$2f$auto__$5b$external$5d$__$28$chart$2e$js$2f$auto$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SquareAIFloat$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
"use client";
;
;
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("main", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$SquareAIFloat$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__["default"], {
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("h3", {
                                style: {
                                    color: "#1a7f6b",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("p", {
                                ...
                                children: "Posez votre question à l’IA sur vos rapports, statistiques ou clients."
                            }, void 0, false, {
                                fileName: "[project]/pages/administration/reports.tsx",
                                lineNumber: 266,
                                columnNumber: 11
...
//# sourceMappingURL=%5Broot-of-the-server%5D__169debe3._.js.map