...
;
// ────────────────────────────────────────────────
// ADRESSES (à remplacer par les tiennes !)
const VEZPROXY_ADDRESS = "0x...TonAdresseVEZproxyIci...";
const FAUCET_ADDRESS = "0x...TonAdresseFaucetIci...";
// ────────────────────────────────────────────────
// ABI minimal
const faucetAbi = [
    {
...
function VyftFaucetPage() {
    ...
    const t = {
        "fr-FR": {
            title: "Vyft Faucet - Claim VEZ Testnet",
            h1: "Faucet VEZ - Testnet Charène",
            subtitle: "Obtenez des VEZ testnet pour expérimenter la néobanque Vyft",
            connectWallet: "Connecter mon portefeuille",
            claimButton: "Claim VEZ",
            claiming: "Claim en cours...",
            cooldown: "Prochain claim dans",
            faucetEmpty: "Faucet vide pour le moment",
            faucetPaused: "Faucet temporairement en pause",
            addToWallet: "Ajouter VEZ au wallet",
            adding: "Ajout en cours...",
            yourBalance: "Votre solde",
            successTitle: "Claim réussi !",
            viewTx: "Voir la transaction",
            faucetBalanceLow: "Solde du faucet insuffisant"
        },
        "en-EN": {
            title: "Vyft Faucet - Claim VEZ Testnet",
            h1: "VEZ Faucet - Charène Testnet",
            subtitle: "Get testnet VEZ to explore Vyft neobank features",
            connectWallet: "Connect Wallet",
            claimButton: "Claim VEZ",
            claiming: "Claiming...",
            cooldown: "Next claim in",
            faucetEmpty: "Faucet currently empty",
            faucetPaused: "Faucet paused",
            addToWallet: "Add VEZ to Wallet",
            adding: "Adding...",
            yourBalance: "Your balance",
            successTitle: "Claim Successful!",
            viewTx: "View transaction",
            faucetBalanceLow: "Faucet balance too low"
        }
    }[locale];
    const { address, isConnected } = useAccount();
    // ─── Lecture depuis le faucet ────────────────────────────────────────
    ...
    const [canClaim, blockedReason] = canClaimData || [
        false,
        ""
    ];
    const { data: dripAmountRaw } = useReadContract({
        address: FAUCET_ADDRESS,
        abi: faucetAbi,
        functionName: "dripAmount"
    });
    const dripAmount = dripAmountRaw ? Number(dripAmountRaw) / 1e18 : 0;
    const { data: userBalanceRaw } = useReadContract({
        address: VEZPROXY_ADDRESS,
        abi: vezAbi,
    ...
    const handleClaim = ()=>{
        if (!canClaim || isClaiming || isConfirming) return;
        writeContract({
            address: FAUCET_ADDRESS,
            abi: faucetAbi,
            functionName: "claim"
    ...
    const addVezToken = async ()=>{
        try {
            ...
            alert("VEZ ajouté au wallet !");
        } catch (err) {
            console.error(err);
            alert("Impossible d'ajouter le token");
        }
    };
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("div", {
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2f$jsx$2d$dev$2d$runtime__$5b$external$5d$__$28$react$2f$jsx$2d$dev$2d$runtime$2c$__cjs$29$__["jsxDEV"])("button", {
                                            ...
                                            children: [
                                                ...
                                                isAddingToken ? t.adding : t.addToWallet
                                            ]
                                        }, void 0, true, {
                                            fileName: "[project]/pages/[lang]/ecosystem/vyft-slura.tsx",
                                            lineNumber: 295,
