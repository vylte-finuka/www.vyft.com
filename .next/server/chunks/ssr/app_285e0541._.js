...
(()=>{
    const e = new Error("Cannot find module 'react-secure-storage'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
"[project]/app/components/CGU_Vyft_content_fr.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CGU_Vyft_content_fr$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/app/components/CGU_Vyft_content_fr.ts [app-ssr] (ecmascript)"); // Assure-toi que ce fichier existe et est exporté
"use client";
;
;
;
...
function SquareAIFloat() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const fetchUserInfo = async ()=>{
            try {
                ...
                const response = await axios.get(`${process.env.NEXT_PUBLIC_AUTH0_DOMAIN}/api/v2/users/${userId}`, {
                    headers: {
                        Authorization: `Bearer ${userToken}`,
                        "Content-Type": "application/json"
                    }
    ...
    async function sendMessage() {
        ...
        context += "\n\nVoici les Conditions Générales d'Utilisation (CGU) officielles de Vyft :\n" + __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$CGU_Vyft_content_fr$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"] + "\n\n";
...
(()=>{
    const e = new Error("Cannot find module './components/SubscribeModal'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
...
function Home() {
    ...
    // Bloc d'accès
    if (!isLoggedIn) {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(Login, {}, void 0, false, {
...
//# sourceMappingURL=app_285e0541._.js.map