...
"[externals]/blob-stream [external] (blob-stream, cjs)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const mod = __turbopack_context__.x("blob-stream", () => require("blob-stream"));
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$blob$2d$stream__$5b$external$5d$__$28$blob$2d$stream$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/blob-stream [external] (blob-stream, cjs)");
...
function ReportsList({ reports = [] }) {
    ...
    function generateServerPDF(report) {
        ...
        const stream = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$blob$2d$stream__$5b$external$5d$__$28$blob$2d$stream$2c$__cjs$29$__["default"])();
        doc.pipe(stream);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e708efbe._.js.map