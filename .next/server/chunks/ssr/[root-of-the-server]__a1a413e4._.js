...
;
;
// Fonction utilitaire pour appeler l'API OpenAI GPT
async function callGpt(prompt) {
    try {
        ...
        return data.reply || "Réponse IA vide.";
    } catch (e) {
        return "Erreur lors de la réponse de l'IA : " + (e.message || "inconnue");
    }
}
function SquareAIFloat() {
    ...
    async function sendMessage() {
        ...
        setLoading(true);
        // Appel réel à GPT via ton API backend
        const reply = await callGpt(input);
        setMessages((msgs)=>[
                ...msgs,
                {
                    from: "ai",
...
// Bulle de conversation cohérente
...
} // Ajoute ce CSS dans globals.css ou dans le composant avec styled-jsx si tu veux :
 /*
@keyframes dotBounce {
...
([__TURBOPACK__imported__module__$5b$externals$5d2f$axios__$5b$external$5d$__$28$axios$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$components$2f$Navbar$2e$tsx__$5b$ssr$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$react$2d$chartjs$2d$2__$5b$external$5d$__$28$react$2d$chartjs$2d$2$2c$__esm_import$29$__, __TURBOPACK__imported__module__$5b$externals$5d2f$chart$2e$js$2f$auto__$5b$external$5d$__$28$chart$2e$js$2f$auto$2c$__esm_import$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__);
;
"use client";
;
;
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a1a413e4._.js.map