...
var __TURBOPACK__imported__module__$5b$externals$5d2f$openai__$5b$external$5d$__$28$openai$2c$__esm_import$29$__ = __turbopack_context__.i("[externals]/openai [external] (openai, esm_import)"); // SDK OpenAI pour GPT
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
...
;
;
// Configuration pour OpenAI API (remplacez par votre clé d'env)
const openai = new __TURBOPACK__imported__module__$5b$externals$5d2f$openai__$5b$external$5d$__$28$openai$2c$__esm_import$29$__["default"]({
    apiKey: "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"
});
// IA via OpenAI API (GPT-4o)
...
const FALLBACKS = [
    ...
    "Je réfléchis... pouvez-vous reformuler ?",
...
function SquareAIFloat() {
    ...
    const [messages, setMessages] = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$react__$5b$external$5d$__$28$react$2c$__cjs$29$__["useState"])([
        {
            from: "ai",
            text: "Bonjour, je suis votre assistant GPT, prêt à aider avec vos rapports. Posez-moi une question !"
        }
    ]);
    ...
    async function sendMessage() {
        ...
        setLoading(true);
        setInput("");
        // Envoie l'historique complet pour le contexte
        const reply = await callGrokAPI([
            ...messages,
            userMessage
        ]);
        setMessages((msgs)=>[
...
// Les composants Bubble, TypingBubble, etc. restent inchangés
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a78949bb._.js.map