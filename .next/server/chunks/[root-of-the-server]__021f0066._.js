...
"[externals]/alchemy-sdk [external] (alchemy-sdk, cjs)": (function(__turbopack_context__) {

var { g: global, __dirname, m: module, e: exports } = __turbopack_context__;
{
const mod = __turbopack_context__.x("alchemy-sdk", () => require("alchemy-sdk"));
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$alchemy$2d$sdk__$5b$external$5d$__$28$alchemy$2d$sdk$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/alchemy-sdk [external] (alchemy-sdk, cjs)");
...
async function USDCEURCconverter(req, res) {
    try {
        ...
        if (approval) {
            // IMPORTANT : Ne passer que le type principal à signTypedData
            const approvalSignature = await wallet.signTypedData(approval.eip712.domain, {
                [approval.eip712.primaryType]: approval.eip712.types[approval.eip712.primaryType]
            }, approval.eip712.message);
            const approvalSignatureSplit = __TURBOPACK__imported__module__$5b$externals$5d2f$alchemy$2d$sdk__$5b$external$5d$__$28$alchemy$2d$sdk$2c$__cjs$29$__["Utils"].splitSignature(approvalSignature);
            approval.signature = {
                v: approvalSignatureSplit.v,
                r: approvalSignatureSplit.r,
                s: approvalSignatureSplit.s,
                signatureType: 2
            };
        }
        // 3. Signer trade
        const tradeSignature = await wallet.signTypedData(trade.eip712.domain, {
            [trade.eip712.primaryType]: trade.eip712.types[trade.eip712.primaryType]
        }, trade.eip712.message);
        const tradeSignatureSplit = __TURBOPACK__imported__module__$5b$externals$5d2f$alchemy$2d$sdk__$5b$external$5d$__$28$alchemy$2d$sdk$2c$__cjs$29$__["Utils"].splitSignature(tradeSignature);
        trade.signature = {
            v: tradeSignatureSplit.v,
            r: tradeSignatureSplit.r,
            s: tradeSignatureSplit.s,
            signatureType: 2
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__021f0066._.js.map