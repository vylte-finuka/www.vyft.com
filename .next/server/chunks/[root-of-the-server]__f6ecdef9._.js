...
async function USDCEURCconverter(req, res) {
    try {
        ...
        const chainId = 43114; // Assurez-vous que cette valeur est correcte
        const sellToken = "0xB97EF9Ef8734C71904D8002F8b6Bc66Dd9c48a6E"; // USDC
        const buyToken = "0xC891EB4cbdEFf6e073e859e987815Ed1505c2ACD"; // EURC
        const sellAmount = "2000000"; // 2 USDC en wei
        const taker = "0x2DE81737589163266Ff70F89CCb12D0655C35853"; // Adresse du preneur
        ...
        const wallet = new __TURBOPACK__imported__module__$5b$externals$5d2f$ethers__$5b$external$5d$__$28$ethers$2c$__esm_import$29$__["ethers"].Wallet(privateKey);
        const quoteParams = {
            chainId,
            sellToken,
            buyToken,
        ...
        const approvalData = {
            ...
            signature: {
                ...
                r: approval.signature.r,
                s: approval.signature.s,
                signatureType: approval.signature.signatureType
            }
        };
        // Construction de tradeData
        const tradeData = {
            type: trade.type,
            hash: trade.hash,
            eip712: {
            ...
            signature: {
                ...
                r: trade.signature.r,
                s: trade.signature.s,
                signatureType: trade.signature.signatureType
            }
        };
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f6ecdef9._.js.map